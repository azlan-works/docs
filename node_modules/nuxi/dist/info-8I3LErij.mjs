import { i as __require, n as __esmMin, t as __commonJSMin } from "./chunk-Cm1iV3aP.mjs";
...
import { r as version } from "./package-CwM-B3zv.mjs";
import { a as legacyRootDirArgs, t as cwdArgs } from "./_shared-CThtxn2Y.mjs";
import { d as Tt, n as logger } from "./logger-wdNiO-Aa.mjs";
import { c as resolve$1 } from "./pathe.M-eThtNZ-0R4k6vpe.mjs";
import { n as tryResolveNuxt } from "./kit-MxYsyKUq.mjs";
import { r as readPackageJSON } from "./dist-DyMkXzmn.mjs";
import "./satisfies-D_ijK3SP.mjs";
import "./versions-B09TCvPG.mjs";
import { t as getBuilder } from "./banner-CGrTqooJ.mjs";
import "./main-tkHm_CH8.mjs";
import { r as detectPackageManager } from "./nypm.CLjaS_sz-CQ4Q1opc.mjs";
import { t as formatInfoBox } from "./formatting-Crzn9NB6.mjs";
import { t as getPackageManagerVersion } from "./packageManagers-L0gaKKPD.mjs";
...
//#endregion
//#region ../../node_modules/.pnpm/tsdown@0.18.4_oxc-resolver@11.16.2_synckit@0.11.11_typescript@5.9.3/node_modules/tsdown/esm-shims.js
...
var info_default = defineCommand({
	...
	async run(ctx) {
		...
		if (!v && await new Promise((resolve$2) => (0, import_copy_paste.copy)(copyStr, (err) => resolve$2(!err)))) Tt(`\n${boxStr}`, ` Nuxt project info ${colors.gray("(copied to clipboard) ")}`, {
			contentAlign: "left",
			titleAlign: "left",
			width: "auto",
			titlePadding: 2,
...
function normalizeConfigModule(module$1, rootDir) {
	if (!module$1) return null;
	if (typeof module$1 === "string") return module$1.split(rootDir).pop().split("node_modules").pop().replace(/^\//, "");
	if (typeof module$1 === "function") return `${module$1.name}()`;
	if (Array.isArray(module$1)) return normalizeConfigModule(module$1[0], rootDir);
	return null;
}
async function getNuxtConfig(rootDir) {
	try {
		const { createJiti } = await import("./jiti-BVVHQQ5d.mjs");
