import { i as __require, t as __commonJSMin } from "./chunk-Cm1iV3aP.mjs";
import { n as colors } from "./dist-CRTRs0Gd.mjs";
import "./utils-D5jIbZ8_.mjs";
import { t as defineCommand } from "./dist-BwyUpa_O.mjs";
import { n as R$2 } from "./dist-DS-XJpoP.mjs";
import { o as logLevelArgs, t as cwdArgs } from "./_shared-CThtxn2Y.mjs";
import { t as runCommand } from "./run-BR-933Xo.mjs";
import { _ as Ct, a as Lt, c as Pt, d as Tt, f as Wt, h as qt, l as Qt, n as logger, o as Mt, p as Xt, s as Nt, u as Se } from "./logger-wdNiO-Aa.mjs";
import { a as join, c as resolve, n as dirname, s as relative, t as basename } from "./pathe.M-eThtNZ-0R4k6vpe.mjs";
import { t as defu } from "./defu-DcpjBOZc.mjs";
import { r as relativeToProcess } from "./kit-MxYsyKUq.mjs";
import { a as writePackageJSON, r as readPackageJSON, t as findFile } from "./dist-DyMkXzmn.mjs";
import "./satisfies-D_ijK3SP.mjs";
import { t as getNuxtVersion } from "./versions-B09TCvPG.mjs";
import "./fs-BnIkSD4A.mjs";
import { n as K } from "./main-tkHm_CH8.mjs";
import { i as installDependencies } from "./nypm.CLjaS_sz-CQ4Q1opc.mjs";
import { n as require_node_fetch_native_DhEqb06g, t as require_node } from "./node-D4f5U3R7.mjs";
import "./jiti-MzZZfWQi.mjs";
import "./node-D1RxKORn.mjs";
import { i as $fetch, n as fetchModules, t as checkNuxtCompatibility } from "./_utils-CU_ieUn1.mjs";
import "./prepare-CDQrAVd1.mjs";
import add_default from "./add-CqEHfDBq.mjs";
...
var require_proxy = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function requireErrors() {
		...
		e(K$1, "RequestContentLengthMismatchError");
		let r = K$1;
		...
		e(gA, "SecureProxyConnectionError");
		return errors = {
			AbortError: Q,
			HTTPParserError: G$1,
			UndiciError: A,
			...
			ResponseContentLengthMismatchError: o$5,
		...
		const { wellknownHeaderNames: A, headerNameLowerCasedRecord: k$1 } = requireConstants$4(), y$3 = class y$4 {
			...
			add(Q, D) {
				...
				for (;;) {
					...
					if (o$5.code === N) if (U === ++r) {
						o$5.value = D;
						break;
					} else if (o$5.middle !== null) o$5 = o$5.middle;
					else {
						o$5.middle = new y$4(Q, D, r);
						break;
					}
					else if (o$5.code < N) if (o$5.left !== null) o$5 = o$5.left;
					else {
						o$5.left = new y$4(Q, D, r);
						break;
					}
					else if (o$5.right !== null) o$5 = o$5.right;
					else {
						o$5.right = new y$4(Q, D, r);
						break;
					}
				}
			}
			search(Q) {
				...
				for (; r !== null && U < D;) {
					let o$5 = Q[U];
					for (o$5 <= 90 && o$5 >= 65 && (o$5 |= 32); r !== null;) {
						if (o$5 === r.code) {
							if (D === ++U) return r;
							r = r.middle;
							break;
						}
						r = r.code < o$5 ? r.left : r.right;
					}
				}
				return null;
			}
	...
	function requireUtil$7() {
		...
		e(Y, "isHttpOrHttpsPrefixed");
		function m$3(W) {
			if (typeof W == "string") {
				if (W = new URL(W), !Y(W.origin || W.protocol)) throw new o$5("Invalid URL protocol: the URL must start with `http:` or `https:`.");
				return W;
			}
			if (!W || typeof W != "object") throw new o$5("Invalid URL: The URL argument must be a non-null object.");
			if (!(W instanceof URL)) {
				if (W.port != null && W.port !== "" && M(W.port) === !1) throw new o$5("Invalid URL: port must be a valid integer or a string representation of an integer.");
				if (W.path != null && typeof W.path != "string") throw new o$5("Invalid URL path: the path must be a string or null/undefined.");
				if (W.pathname != null && typeof W.pathname != "string") throw new o$5("Invalid URL pathname: the pathname must be a string or null/undefined.");
				if (W.hostname != null && typeof W.hostname != "string") throw new o$5("Invalid URL hostname: the hostname must be a string or null/undefined.");
				if (W.origin != null && typeof W.origin != "string") throw new o$5("Invalid URL origin: the origin must be a string or null/undefined.");
				if (!Y(W.origin || W.protocol)) throw new o$5("Invalid URL protocol: the URL must start with `http:` or `https:`.");
		...
		e(m$3, "parseURL");
		function f$4(W) {
			if (W = m$3(W), W.pathname !== "/" || W.search || W.hash) throw new o$5("invalid url");
			return W;
		}
		e(f$4, "parseOrigin");
		function n$4(W) {
		...
		e(CA, "parseRawHeaders");
		function pA(W) {
			return W instanceof Uint8Array || Buffer.isBuffer(W);
		}
		e(pA, "isBuffer");
		function fA(W, cA, yA) {
			if (!W || typeof W != "object") throw new o$5("handler must be an object");
			if (typeof W.onConnect != "function") throw new o$5("invalid onConnect method");
			if (typeof W.onError != "function") throw new o$5("invalid onError method");
			if (typeof W.onBodySent != "function" && W.onBodySent !== void 0) throw new o$5("invalid onBodySent method");
			if (yA || cA === "CONNECT") {
				if (typeof W.onUpgrade != "function") throw new o$5("invalid onUpgrade method");
			} else {
				if (typeof W.onHeaders != "function") throw new o$5("invalid onHeaders method");
				if (typeof W.onData != "function") throw new o$5("invalid onData method");
				if (typeof W.onComplete != "function") throw new o$5("invalid onComplete method");
			}
		}
		e(fA, "validateHandler");
		function kA(W) {
	...
	function requireDiagnostics() {
		...
		if (c$5.enabled || B.enabled) {
			...
			A.channel("undici:client:beforeConnect").subscribe((Q) => {
				const { connectParams: { version: D, protocol: U, port: r, host: o$5 } } = Q;
				F$3("connecting to %s using %s%s", `${o$5}${r ? `:${r}` : ""}`, U, D);
			}), A.channel("undici:client:connected").subscribe((Q) => {
				const { connectParams: { version: D, protocol: U, port: r, host: o$5 } } = Q;
				F$3("connected to %s using %s%s", `${o$5}${r ? `:${r}` : ""}`, U, D);
			}), A.channel("undici:client:connectError").subscribe((Q) => {
				const { connectParams: { version: D, protocol: U, port: r, host: o$5 }, error: N } = Q;
				F$3("connection to %s using %s%s errored - %s", `${o$5}${r ? `:${r}` : ""}`, U, D, N.message);
				...
				const { request: { method: D, path: U, origin: r }, response: { statusCode: o$5 } } = Q;
				F$3("received response to %s %s/%s - HTTP %d", D, r, U, o$5);
				...
				const { request: { method: D, path: U, origin: r }, error: o$5 } = Q;
				F$3("request to %s %s/%s errored - %s", D, r, U, o$5.message);
			}), y$3 = !0;
		}
		if (t$6.enabled) {
			if (!y$3) {
				...
				A.channel("undici:client:beforeConnect").subscribe((Q) => {
					const { connectParams: { version: D, protocol: U, port: r, host: o$5 } } = Q;
					F$3("connecting to %s%s using %s%s", o$5, r ? `:${r}` : "", U, D);
				}), A.channel("undici:client:connected").subscribe((Q) => {
					const { connectParams: { version: D, protocol: U, port: r, host: o$5 } } = Q;
					F$3("connected to %s%s using %s%s", o$5, r ? `:${r}` : "", U, D);
				}), A.channel("undici:client:connectError").subscribe((Q) => {
					const { connectParams: { version: D, protocol: U, port: r, host: o$5 }, error: N } = Q;
					F$3("connection to %s%s using %s%s errored - %s", o$5, r ? `:${r}` : "", U, D, N.message);
				}), A.channel("undici:client:sendHeaders").subscribe((Q) => {
					const { request: { method: D, path: U, origin: r } } = Q;
					F$3("sending request to %s %s/%s", D, r, U);
				});
	...
	function requireRequest$1() {
		...
		const { InvalidArgumentError: A, NotSupportedError: k$1 } = requireErrors(), c$5 = require$$0__default$1, { isValidHTTPToken: B, isValidHeaderValue: t$6, isStream: y$3, destroy: R$3, isBuffer: F$3, isFormDataLike: Q, isIterable: D, isBlobLike: U, buildURL: r, validateHandler: o$5, getServerName: N, normalizedMethodRecords: l$1 } = requireUtil$7(), { channels: I } = requireDiagnostics(), { headerNameLowerCasedRecord: p$1 } = requireConstants$4(), b = /[^\u0021-\u00ff]/, G$1 = Symbol("handler"), _$1 = class _$2 {
			constructor(M, { path: Y, method: m$3, body: f$4, headers: n$4, query: C$1, idempotent: w$2, blocking: S$1, upgrade: x, headersTimeout: z$1, bodyTimeout: $, reset: K$1, throwOnError: nA, expectContinue: iA, servername: uA }, RA) {
				...
				if (this.headersTimeout = z$1, this.bodyTimeout = $, this.throwOnError = nA === !0, this.method = m$3, this.abort = null, f$4 == null) this.body = null;
					...
					(!IA || !IA.autoDestroy) && (this.endHandler = e(function() {
						R$3(this);
				...
				o$5(RA, m$3, x), this.servername = uA || N(this.host), this[G$1] = RA, I.create.hasSubscribers && I.create.publish({ request: this });
			}
			onBodySent(M) {
		...
		return e(V, "processHeader"), request$1 = J$1, request$1;
	}
	...
	function requireDispatcher() {
		...
		t$6 = /* @__PURE__ */ new WeakMap(), y$3 = /* @__PURE__ */ new WeakMap(), e(R$3, "ComposedDispatcher");
		let c$5 = R$3;
	...
	function requireDispatcherBase() {
		...
		const A = requireDispatcher(), { ClientDestroyedError: k$1, ClientClosedError: c$5, InvalidArgumentError: B } = requireErrors(), { kDestroy: t$6, kClose: y$3, kClosed: R$3, kDestroyed: F$3, kDispatch: Q, kInterceptors: D } = requireSymbols$4(), U = Symbol("onDestroyed"), r = Symbol("onClosed"), o$5 = Symbol("Intercepted Dispatch"), l$1 = class l$2 extends A {
			constructor() {
			...
			[o$5](p$1, b) {
				if (!this[D] || this[D].length === 0) return this[o$5] = this[Q], this[Q](p$1, b);
				let G$1 = this[Q].bind(this);
				for (let J$1 = this[D].length - 1; J$1 >= 0; J$1--) G$1 = this[D][J$1](G$1);
				return this[o$5] = G$1, G$1(p$1, b);
			}
			dispatch(p$1, b) {
	...
	function requireTimers() {
		...
		return timers = {
			setTimeout(I, p$1, b) {
				return p$1 <= k$1 ? setTimeout(I, p$1, b) : new o$5(I, p$1, b);
			},
			clearTimeout(I) {
				I[t$6] ? I.clear() : clearTimeout(I);
			},
			setFastTimeout(I, p$1, b) {
				return new o$5(I, p$1, b);
			},
			clearFastTimeout(I) {
				I.clear();
			},
	...
	function requireConnect() {
		...
		e(R$3, "noop");
		let F$3, Q;
		_commonjsHelpers.commonjsGlobal.FinalizationRegistry && !(process.env.NODE_V8_COVERAGE || process.env.UNDICI_NO_FG) ? Q = (o$5 = class {
			constructor(I) {
		...
		}, e(o$5, "WeakSessionCache"), o$5) : Q = (N = class {
			constructor(I) {
		...
		function D({ allowH2: l$1, maxCachedSessions: I, socketPath: p$1, timeout: b, session: G$1, ...J$1 }) {
			...
			return b = b ?? 1e4, l$1 = l$1 ?? !1, e(function({ hostname: M, host: Y, protocol: m$3, port: f$4, servername: n$4, localAddress: C$1, httpSocket: w$2 }, S$1) {
				let x;
				if (m$3 === "https:") {
		...
		return e(r, "onConnectTimeout"), connect = D, connect;
	}
	...
	function requireGlobal$1() {
		...
		return e(c$5, "setGlobalOrigin"), global$1 = {
			getGlobalOrigin: k$1,
			setGlobalOrigin: c$5
		}, global$1;
	}
	...
	function requireDataUrl() {
		...
		e(D, "collectASequenceOfCodePointsFast");
		function U(m$3) {
			return N(k$1.encode(m$3));
		}
		e(U, "stringPercentDecode");
		function r(m$3) {
		...
		e(o$5, "hexByteToNumber");
		function N(m$3) {
			const f$4 = m$3.length, n$4 = new Uint8Array(f$4);
			let C$1 = 0;
			for (let w$2 = 0; w$2 < f$4; ++w$2) {
				const S$1 = m$3[w$2];
				S$1 !== 37 ? n$4[C$1++] = S$1 : S$1 === 37 && !(r(m$3[w$2 + 1]) && r(m$3[w$2 + 2])) ? n$4[C$1++] = 37 : (n$4[C$1++] = o$5(m$3[w$2 + 1]) << 4 | o$5(m$3[w$2 + 2]), w$2 += 2);
			}
		...
		e(p$1, "collectAnHTTPQuotedString");
		function b(m$3) {
			A(m$3 !== "failure");
		...
		return e(Y, "minimizeSupportedMimeType"), dataUrl = {
	...
	function requireWebidl() {
		...
		return t$6.converters = {}, t$6.util = {}, t$6.errors = {}, t$6.errors.exception = function(y$3) {
			...
			return (F$3, Q, D) => {
				...
				const U = {};
				if (!A.isProxy(F$3)) {
					const o$5 = [...Object.getOwnPropertyNames(F$3), ...Object.getOwnPropertySymbols(F$3)];
					for (const N of o$5) {
						const l$1 = y$3(N, Q, D);
						U[l$1] = R$3(F$3[N], Q, D);
					}
				...
				for (const o$5 of r) if (Reflect.getOwnPropertyDescriptor(F$3, o$5)?.enumerable) {
					const l$1 = y$3(o$5, Q, D);
					U[l$1] = R$3(F$3[o$5], Q, D);
				}
				return U;
			};
			...
			return (R$3, F$3, Q) => {
				...
				for (const r of y$3) {
					const { key: o$5, defaultValue: N, required: l$1, converter: I } = r;
					if (l$1 === !0 && !Object.hasOwn(R$3, o$5)) throw t$6.errors.exception({
						header: F$3,
						message: `Missing required key "${o$5}".`
					});
					let p$1 = R$3[o$5];
					const b = Object.hasOwn(r, "defaultValue");
					if (b && p$1 !== null && (p$1 ?? (p$1 = N())), l$1 || b || p$1 !== void 0) {
						if (p$1 = I(p$1, F$3, `${Q}.${o$5}`), r.allowedValues && !r.allowedValues.includes(p$1)) throw t$6.errors.exception({
							header: F$3,
...
`) || v$2.includes("\r") || v$2.includes("\0")) === !1;
		...
		e(S$1, "setRequestReferrerPolicyOnRedirect");
		function x() {
			return "allowed";
		}
		e(x, "crossOriginResourcePolicyCheck");
		function z$1() {
			return "success";
		}
		e(z$1, "corsCheck");
		...
		e(nA, "appendRequestOriginHeader");
		function iA(v$2, X$2) {
			return v$2;
		}
		e(iA, "coarsenTime");
		...
		e(uA, "clampAndCoarsenConnectionTimingInfo");
		function RA(v$2) {
			return iA(U.now());
		}
		e(RA, "coarsenedSharedCurrentTime");
		function IA(v$2) {
			return {
		...
		e(IA, "createOpaqueTimingInfo");
		function CA() {
			return { referrerPolicy: "strict-origin-when-cross-origin" };
		}
		e(CA, "makePolicyContainer");
		function pA(v$2) {
			return { referrerPolicy: v$2.referrerPolicy };
		}
		e(pA, "clonePolicyContainer");
		function fA(v$2) {
		...
		e(fA, "determineRequestsReferrer");
		function kA(v$2, X$2) {
		...
		e(bA, "isURLPotentiallyTrustworthy");
		function gA(v$2, X$2) {
		...
		e(EA, "filterMetadataListByAlgorithm");
		function sA(v$2, X$2) {
		...
		function NA(v$2) {}
		e(NA, "tryUpgradeRequestToAPotentiallyTrustworthyURL");
		function wA(v$2, X$2) {
		...
		e(OA, "serializeJavascriptValueToJSONString");
		...
		function ZA(v$2, X$2, j$2 = 0, tA = 1) {
			...
			FA = /* @__PURE__ */ new WeakMap(), TA = /* @__PURE__ */ new WeakMap(), VA = /* @__PURE__ */ new WeakMap(), e(YA, "FastIterableIterator");
			let rA = YA;
		...
		function HA(v$2, X$2, j$2, tA = 0, rA = 1) {
			const FA = ZA(v$2, j$2, tA, rA), TA = {
				...
				forEach: {
					...
					enumerable: !0,
					configurable: !0,
					value: e(function(YA, _A = globalThis) {
		...
		e(jA, "readableStreamClose");
		const Ae = /[^\x00-\xFF]/;
		function QA(v$2) {
			return I(!Ae.test(v$2)), v$2;
		}
		e(QA, "isomorphicEncode");
		...
		e(yA, "urlHasHttpsScheme");
		function LA(v$2) {
			I("protocol" in v$2);
			const X$2 = v$2.protocol;
			return X$2 === "http:" || X$2 === "https:";
		}
		e(LA, "urlIsHttpHttpsScheme");
		function JA(v$2, X$2) {
			const j$2 = v$2;
		...
		xA = /* @__PURE__ */ new WeakMap(), e(zA, "InflateStream");
		let te = zA;
		function ie(v$2) {
			return new te(v$2);
		}
		...
		e(AA, "EnvironmentSettingsObject");
		return util$6 = {
			isAborted: dA,
			isCancelled: XA,
			isValidEncodedURL: q$1,
			createDeferredPromise: vA,
			ReadableStreamFrom: o$5,
	...
	function requireFormdata() {
		...
		const { isBlobLike: A, iteratorMixin: k$1 } = requireUtil$6(), { kState: c$5 } = requireSymbols$3(), { kEnumerableProperty: B } = requireUtil$7(), { FileLike: t$6, isFileLike: y$3 } = requireFile(), { webidl: R$3 } = requireWebidl(), { File: F$3 } = require$$0__default, Q = require$$0__default$3, D = globalThis.File ?? F$3, o$5 = class o$6 {
			constructor(l$1) {
...
`);
		...
		function p$1(q$1, M) {
			...
			for (C$1 !== q$1.length && (q$1 = q$1.subarray(0, C$1));;) {
				...
				if (n$4.position === q$1.length - 2 && _$1(q$1, o$5, n$4) || n$4.position === q$1.length - 4 && _$1(q$1, N, n$4)) return f$4;
		...
		e(b, "parseMultipartFormDataHeaders");
		function G$1(q$1, M) {
...
`).replace(/%0D/gi, "\r").replace(/%22/g, "\""), Y);
		...
		return e(_$1, "bufferStartsWith"), formdataParser = {
	...
	function requireBody() {
		...
		hasRequiredBody = 1;
		const A = requireUtil$7(), { ReadableStreamFrom: k$1, isBlobLike: c$5, isReadableStreamLike: B, readableStreamClose: t$6, createDeferredPromise: y$3, fullyReadBody: R$3, extractMimeType: F$3, utf8DecodeBytes: Q } = requireUtil$6(), { FormData: D } = requireFormdata(), { kState: U } = requireSymbols$3(), { webidl: r } = requireWebidl(), { Blob: o$5 } = require$$0__default, N = require$$0__default$1, { isErrored: l$1, isDisturbed: I } = Stream__default, { isArrayBuffer: p$1 } = require$$8__default$1, { serializeAMimeType: b } = requireDataUrl(), { multipartFormDataParser: G$1 } = requireFormdataParser();
		let J$1;
		try {
			const K$1 = __require("node:crypto");
			J$1 = e((nA) => K$1.randomInt(0, nA), "random");
		} catch {
			J$1 = e((K$1) => Math.floor(Math.random(K$1)), "random");
		}
...
Content-Disposition: form-data`;
				/*! formdata-polyfill. MIT License. Jimmy Wärting <https://jimmy.warting.se/opensource> */ const bA = e((sA) => sA.replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22"), "escape"), gA = e((sA) => sA.replace(/\r?\n|\r/g, `\r
...
`);
				DA.push(EA), IA += EA.byteLength, aA && (IA = null), RA = K$1, uA = e(async function* () {
		...
		e(n$4, "throwIfAborted");
		function C$1(K$1) {
			return {
				blob() {
					return S$1(this, (iA) => {
						let uA = $(this);
						return uA === null ? uA = "" : uA && (uA = b(uA)), new o$5([iA], { type: uA });
					}, K$1);
				},
				arrayBuffer() {
		...
		async function S$1(K$1, nA, iA) {
			...
			n$4(K$1[U]);
			const uA = y$3(), RA = e((CA) => uA.reject(CA), "errorSteps"), IA = e((CA) => {
				try {
					uA.resolve(nA(CA));
				} catch (pA) {
					RA(pA);
	...
	function requireClientH1() {
		...
		async function NA() {
			...
			return await WebAssembly.instantiate(eA, { env: {
				wasm_on_url: e((lA, BA, hA) => 0, "wasm_on_url"),
				wasm_on_status: e((lA, BA, hA) => {
					A(dA.ptr === lA);
					const MA = BA - OA + XA.byteOffset;
					return dA.onStatus(new oA(XA.buffer, MA, hA)) || 0;
				}, "wasm_on_status"),
				wasm_on_message_begin: e((lA) => (A(dA.ptr === lA), dA.onMessageBegin() || 0), "wasm_on_message_begin"),
				wasm_on_header_field: e((lA, BA, hA) => {
					A(dA.ptr === lA);
					const MA = BA - OA + XA.byteOffset;
					return dA.onHeaderField(new oA(XA.buffer, MA, hA)) || 0;
				}, "wasm_on_header_field"),
				wasm_on_header_value: e((lA, BA, hA) => {
					A(dA.ptr === lA);
					const MA = BA - OA + XA.byteOffset;
					return dA.onHeaderValue(new oA(XA.buffer, MA, hA)) || 0;
				}, "wasm_on_header_value"),
				wasm_on_headers_complete: e((lA, BA, hA, MA) => (A(dA.ptr === lA), dA.onHeadersComplete(BA, !!hA, !!MA) || 0), "wasm_on_headers_complete"),
				wasm_on_body: e((lA, BA, hA) => {
					A(dA.ptr === lA);
					const MA = BA - OA + XA.byteOffset;
					return dA.onBody(new oA(XA.buffer, MA, hA)) || 0;
				}, "wasm_on_body"),
				wasm_on_message_complete: e((lA) => (A(dA.ptr === lA), dA.onMessageComplete() || 0), "wasm_on_message_complete")
			} });
		}
		e(NA, "lazyllhttp");
		let wA = null, vA = NA();
			...
			execute(eA) {
				...
				try {
					...
					if (hA === gA.ERROR.PAUSED_UPGRADE) this.onUpgrade(eA.slice(MA));
						...
						throw new o$5(zA, gA.ERROR[hA], eA.slice(MA));
					}
				} catch (hA) {
					k$1.destroy(lA, hA);
				}
...
`;
		...
		function LA(GA, eA, lA, BA, hA, MA, xA, zA) {
			...
			}, "onData"), X$2 = e(function() {
				UA || eA.resume && eA.resume();
			}, "onDrain"), j$2 = e(function() {
				if (queueMicrotask(() => {
...
`, "latin1"), hA.write(UA), hA.uncork(), BA.onBodySent(UA), BA.onRequestSent(), !zA && BA.reset !== !1 && (hA[I] = !0), lA[kA]();
		...
		async function te(GA, eA, lA, BA, hA, MA, xA, zA) {
			...
			e(AA, "onDrain");
			const v$2 = e(() => new Promise((j$2, tA) => {
...
`, "latin1"), lA !== null && hA !== lA) {
	...
	function requireClientH2() {
		...
		const A = require$$0__default$1, { pipeline: k$1 } = Stream__default, c$5 = requireUtil$7(), { RequestContentLengthMismatchError: B, RequestAbortedError: t$6, SocketError: y$3, InformationalError: R$3 } = requireErrors(), { kUrl: F$3, kReset: Q, kClient: D, kRunning: U, kPending: r, kQueue: o$5, kPendingIdx: N, kRunningIdx: l$1, kError: I, kSocket: p$1, kStrictContentLength: b, kOnError: G$1, kMaxConcurrentStreams: J$1, kHTTP2Session: V, kResume: _$1, kSize: q$1, kHTTPContext: M } = requireSymbols$4(), Y = Symbol("open streams");
		let m$3, f$4 = !1, n$4;
		try {
		...
		async function iA(aA, EA) {
			...
			const sA = n$4.connect(aA[F$3], {
				createConnection: e(() => EA, "createConnection"),
		...
		e(IA, "onHttp2FrameError");
		function CA() {
			const aA = new y$3("other side closed", c$5.getSocketInfo(this[p$1]));
			this.destroy(aA), c$5.destroy(this[p$1], aA);
		}
		e(CA, "onHttp2SessionEnd");
		function pA(aA) {
			const EA = this[I] || new y$3(`HTTP/2: "GOAWAY" frame received with code ${aA}`, c$5.getSocketInfo(this)), sA = this[D];
			if (sA[p$1] = null, sA[M] = null, this[V] != null && (this[V].destroy(EA), this[V] = null), c$5.destroy(this[p$1], EA), sA[l$1] < sA[o$5].length) {
				const NA = sA[o$5][sA[l$1]];
				sA[o$5][sA[l$1]++] = null, c$5.errorRequest(sA, NA, EA), sA[N] = sA[l$1];
			}
		...
		function kA(aA, EA) {
			...
			const jA = e((yA) => {
				EA.aborted || EA.completed || (yA = yA || new t$6(), c$5.errorRequest(aA, EA, yA), HA != null && c$5.destroy(HA, yA), c$5.destroy(PA, yA), aA[o$5][aA[l$1]++] = null, aA[_$1]());
			}, "abort");
			try {
				EA.onConnect(jA);
			} catch (yA) {
			...
			if (NA === "CONNECT") return sA.ref(), HA = sA.request(ZA, {
				endStream: !1,
				signal: KA
			}), HA.id && !HA.pending ? (EA.onUpgrade(null, null, HA), ++sA[Y], aA[o$5][aA[l$1]++] = null) : HA.once("ready", () => {
				EA.onUpgrade(null, null, HA), ++sA[Y], aA[o$5][aA[l$1]++] = null;
			}), HA.once("close", () => {
			...
			return XA ? (ZA[$] = "100-continue", HA = sA.request(ZA, {
				...
				(HA.state?.state == null || HA.state.state < 6) && EA.onComplete([]), sA[Y] === 0 && sA.unref(), jA(new R$3("HTTP/2: stream half-closed (remote)")), aA[o$5][aA[l$1]++] = null, aA[N] = aA[l$1], aA[_$1]();
			}), HA.once("close", () => {
				sA[Y] -= 1, sA[Y] === 0 && sA.unref();
		...
		return e(oA, "writeIterable"), clientH2 = iA, clientH2;
	}
	...
	function requireRedirectInterceptor() {
		...
		return e(k$1, "createRedirectInterceptor"), redirectInterceptor = k$1, redirectInterceptor;
	}
		...
		const Ae = class Ae$1 extends R$3 {
			constructor(W, { interceptors: cA, maxHeaderSize: yA, headersTimeout: LA, socketTimeout: JA, requestTimeout: WA, connectTimeout: te, bodyTimeout: ie, idleTimeout: oe, keepAlive: Ie, keepAliveTimeout: GA, maxKeepAliveTimeout: eA, keepAliveMaxTimeout: lA, keepAliveTimeoutThreshold: BA, socketPath: hA, pipelining: MA, tls: xA, strictContentLength: zA, maxCachedSessions: UA, maxRedirections: AA, connect: v$2, maxRequestsPerClient: X$2, localAddress: j$2, maxResponseSize: tA, autoSelectFamily: rA, autoSelectFamilyAttemptTimeout: FA, maxConcurrentStreams: TA, allowH2: VA } = {}) {
				...
				typeof v$2 != "function" && (v$2 = U({
					...
					...v$2
				})), cA?.Client && Array.isArray(cA.Client) ? (this[bA] = cA.Client, vA || (vA = !0, process.emitWarning("Client.Options#interceptor is deprecated. Use Dispatcher#compose instead.", { code: "UNDICI-CLIENT-INTERCEPTOR-DEPRECATED" }))) : this[bA] = [PA({ maxRedirections: AA })], this[r] = B.parseOrigin(W), this[uA] = v$2, this[w$2] = MA ?? 1, this[x] = yA || c$5.maxHeaderSize, this[Y] = GA ?? 4e3, this[z$1] = lA ?? 6e5, this[$] = BA ?? 2e3, this[S$1] = this[Y], this[o$5] = null, this[gA] = j$2 ?? null, this[p$1] = 0, this[M] = 0, this[m$3] = `host: ${this[r].hostname}${this[r].port ? `:${this[r].port}` : ""}\r
`, this[nA] = ie ?? 3e5, this[K$1] = LA ?? 3e5, this[iA] = zA ?? !0, this[RA] = AA, this[IA] = X$2, this[dA] = null, this[DA] = tA > -1 ? tA : -1, this[EA] = TA ?? 100, this[aA] = null, this[V] = [], this[n$4] = 0, this[f$4] = 0, this[sA] = (YA) => ne(this, YA), this[oA] = (YA) => ZA(this, YA);
		...
		async function HA(QA) {
			...
			try {
				...
				if (QA[q$1] = !1, t$6.connectError.hasSubscribers && t$6.connectError.publish({
					...
					connector: QA[uA],
					error: JA
				}), JA.code === "ERR_TLS_CERT_ALTNAME_INVALID") for (A(QA[b] === 0); QA[G$1] > 0 && QA[V][QA[f$4]].servername === QA[o$5];) {
		...
		function jA(QA, W) {
			for (;;) {
				...
				if (QA[r].protocol === "https:" && QA[o$5] !== cA.servername) {
					if (QA[b] > 0) return;
					QA[o$5] = cA.servername, QA[aA]?.destroy(new Q("servername changed"), () => {
						QA[aA] = null, ne(QA);
					});
				}
				if (QA[q$1]) return;
		...
		return e(jA, "_resume"), client = OA, client;
	}
	...
	function requireFixedQueue() {
		...
		}, e(t$6, "FixedQueue"), t$6), fixedQueue;
	}
	...
	function requirePool() {
		...
		hasRequiredPool = 1;
		const { PoolBase: A, kClients: k$1, kNeedDrain: c$5, kAddClient: B, kGetDispatcher: t$6 } = requirePoolBase(), y$3 = requireClient(), { InvalidArgumentError: R$3 } = requireErrors(), F$3 = requireUtil$7(), { kUrl: Q, kInterceptors: D } = requireSymbols$4(), U = requireConnect(), r = Symbol("options"), o$5 = Symbol("connections"), N = Symbol("factory");
		function l$1(b, G$1) {
			return new y$3(b, G$1);
		}
		e(l$1, "defaultFactory");
		const p$1 = class p$2 extends A {
			constructor(G$1, { connections: J$1, factory: V = l$1, connect: _$1, connectTimeout: q$1, tls: M, maxCachedSessions: Y, socketPath: m$3, autoSelectFamily: f$4, autoSelectFamilyAttemptTimeout: n$4, allowH2: C$1, ...w$2 } = {}) {
				...
				typeof _$1 != "function" && (_$1 = U({
					...
					..._$1
				})), this[D] = w$2.interceptors?.Pool && Array.isArray(w$2.interceptors.Pool) ? w$2.interceptors.Pool : [], this[o$5] = J$1 || null, this[Q] = F$3.parseOrigin(G$1), this[r] = {
					...F$3.deepClone(w$2),
					connect: _$1,
					allowH2: C$1
			...
			[t$6]() {
				...
				if (!this[o$5] || this[k$1].length < this[o$5]) {
	...
	function requireBalancedPool() {
		...
		const M = class M$1 extends c$5 {
			constructor(m$3 = [], { factory: f$4 = _$1, ...n$4 } = {}) {
				...
				this[U] = n$4.interceptors?.BalancedPool && Array.isArray(n$4.interceptors.BalancedPool) ? n$4.interceptors.BalancedPool : [], this[o$5] = f$4;
			...
			addUpstream(m$3) {
				...
				const n$4 = this[o$5](f$4, Object.assign({}, this[N]));
	...
	function requireAgent() {
		...
		hasRequiredAgent = 1;
		const { InvalidArgumentError: A } = requireErrors(), { kClients: k$1, kRunning: c$5, kClose: B, kDestroy: t$6, kDispatch: y$3, kInterceptors: R$3 } = requireSymbols$4(), F$3 = requireDispatcherBase(), Q = requirePool(), D = requireClient(), U = requireUtil$7(), r = requireRedirectInterceptor(), o$5 = Symbol("onConnect"), N = Symbol("onDisconnect"), l$1 = Symbol("onConnectionError"), I = Symbol("maxRedirections"), p$1 = Symbol("onDrain"), b = Symbol("factory"), G$1 = Symbol("options");
		function J$1(q$1, M) {
			return M && M.connections === 1 ? new D(q$1, M) : new Q(q$1, M);
		}
		e(J$1, "defaultFactory");
		const _$1 = class _$2 extends F$3 {
			...
			[y$3](M, Y) {
				...
				return f$4 || (f$4 = this[b](M.origin, this[G$1]).on("drain", this[p$1]).on("connect", this[o$5]).on("disconnect", this[N]).on("connectionError", this[l$1]), this[k$1].set(m$3, f$4)), f$4.dispatch(M, Y);
			}
			async [B]() {
				const M = [];
	...
	function requireProxyAgent() {
		...
		const V = e(() => {}, "noop"), f$4 = class f$5 extends F$3 {
			constructor(w$2) {
				...
				this[b] = r({ ...w$2.requestTls }), this[N] = S$1(x, { connect: IA }), this[o$5] = new y$3({
					...w$2,
					connect: e(async (CA, pA) => {
						let fA = CA.host;
			...
			dispatch(w$2, S$1) {
				...
				return this[o$5].dispatch({
					...w$2,
					headers: x
				}, S$1);
			}
			async [k$1]() {
				await this[o$5].close(), await this[N].close();
			}
			async [c$5]() {
				await this[o$5].destroy(), await this[N].destroy();
			}
		};
		Y = /* @__PURE__ */ new WeakSet(), Je = e(function(w$2) {
			return typeof w$2 == "string" ? new t$6(w$2) : w$2 instanceof t$6 ? w$2 : new t$6(w$2.uri);
		}, "#getUrl"), e(f$4, "ProxyAgent");
		let _$1 = f$4;
		function q$1(n$4) {
		...
		return e(M, "throwIfProxyAuthIsSent"), proxyAgent = _$1, proxyAgent;
	}
	...
	function requireEnvHttpProxyAgent() {
		...
		const M = class M$1 extends A {
			constructor(f$4 = {}) {
				...
				SA(this, I, null);
				SA(this, p$1, null);
				mA(this, p$1, f$4), o$5 || (o$5 = !0, process.emitWarning("EnvHttpProxyAgent is experimental, expect them to change at any time.", { code: "UNDICI-EHPA" }));
		...
		l$1 = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), p$1 = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new WeakSet(), ve = e(function(f$4) {
		...
		}, "#getProxyAgentForUrl"), He = e(function(f$4, n$4) {
		...
		}, "#parseNoProxy"), Ve = e(function() {
			return Z(this, p$1).noProxy !== void 0 ? !1 : Z(this, l$1) !== Z(this, b, me$1);
		}, "#noProxyChanged"), me$1 = e(function() {
			return process.env.no_proxy ?? process.env.NO_PROXY ?? "";
		}, "#noProxyEnv"), e(M, "EnvHttpProxyAgent");
	...
	function requireRetryHandler() {
		...
		e(F$3, "calculateRetryAfterHeader");
		const D = class D$1 {
			constructor(r, o$5) {
				...
				this.dispatch = o$5.dispatch, this.handler = o$5.handler, this.opts = {
					...l$1,
					body: R$3(r.body)
			...
			onUpgrade(r, o$5, N) {
				this.handler.onUpgrade && this.handler.onUpgrade(r, o$5, N);
			}
			onConnect(r) {
			...
			static [k$1](r, { state: o$5, opts: N }, l$1) {
				const { statusCode: I, code: p$1, headers: b } = r, { method: G$1, retryOptions: J$1 } = N, { maxRetries: V, minTimeout: _$1, maxTimeout: q$1, timeoutFactor: M, statusCodes: Y, errorCodes: m$3, methods: f$4 } = J$1, { counter: n$4 } = o$5;
			...
			onHeaders(r, o$5, N, l$1) {
				const I = t$6(o$5);
				if (this.retryCount += 1, r >= 300) return this.retryOpts.statusCodes.includes(r) === !1 ? this.handler.onHeaders(r, o$5, N, l$1) : (this.abort(new c$5("Request failed", r, {
					headers: I,
				...
				if (this.end == null) {
					if (r === 206) {
						const b = y$3(I["content-range"]);
						if (b == null) return this.handler.onHeaders(r, o$5, N, l$1);
						const { start: G$1, size: J$1, end: V = J$1 - 1 } = b;
					...
					return A(Number.isFinite(this.start)), A(this.end == null || Number.isFinite(this.end), "invalid content-length"), this.resume = N, this.etag = I.etag != null ? I.etag : null, this.etag != null && this.etag.startsWith("W/") && (this.etag = null), this.handler.onHeaders(r, o$5, N, l$1);
				}
	...
	function requireRetryAgent() {
		...
		B = /* @__PURE__ */ new WeakMap(), t$6 = /* @__PURE__ */ new WeakMap(), e(y$3, "RetryAgent");
	...
	function requireReadable() {
		...
		function q$1(f$4) {
			...
			try {
				n$4 === "text" ? w$2(V(C$1, x)) : n$4 === "json" ? w$2(JSON.parse(V(C$1, x))) : n$4 === "arrayBuffer" ? w$2(_$1(C$1, x).buffer) : n$4 === "blob" ? w$2(new Blob(C$1, { type: S$1[o$5] })) : n$4 === "bytes" && w$2(_$1(C$1, x)), Y(f$4);
			} catch (z$1) {
				S$1.destroy(z$1);
			}
		}
		...
		return e(Y, "consumeFinish"), readable = {
			Readable: I,
			chunksDecode: V
		}, readable;
	}
	...
	function requireUtil$5() {
		...
		async function t$6({ callback: F$3, body: Q, contentType: D, statusCode: U, statusMessage: r, headers: o$5 }) {
			A(Q);
			let N = [], l$1 = 0;
			try {
			...
			if (U === 204 || !D || !l$1) {
				queueMicrotask(() => F$3(new k$1(I, U, o$5)));
				return;
			}
			...
			queueMicrotask(() => F$3(new k$1(I, U, o$5, b)));
		}
		e(t$6, "getResolveErrorBodyCallback");
		const y$3 = e((F$3) => F$3.length > 15 && F$3[11] === "/" && F$3[0] === "a" && F$3[1] === "p" && F$3[2] === "p" && F$3[3] === "l" && F$3[4] === "i" && F$3[5] === "c" && F$3[6] === "a" && F$3[7] === "t" && F$3[8] === "i" && F$3[9] === "o" && F$3[10] === "n" && F$3[12] === "j" && F$3[13] === "s" && F$3[14] === "o" && F$3[15] === "n", "isContentTypeApplicationJson"), R$3 = e((F$3) => F$3.length > 4 && F$3[4] === "/" && F$3[0] === "t" && F$3[1] === "e" && F$3[2] === "x" && F$3[3] === "t", "isContentTypeText");
		return util$5 = {
	...
	function requireApiRequest() {
		...
		const A = require$$0__default$1, { Readable: k$1 } = requireReadable(), { InvalidArgumentError: c$5, RequestAbortedError: B } = requireErrors(), t$6 = requireUtil$7(), { getResolveErrorBodyCallback: y$3 } = requireUtil$5(), { AsyncResource: R$3 } = require$$5__default$2, D = class D$1 extends R$3 {
			constructor(r, o$5) {
				...
				try {
					if (typeof o$5 != "function") throw new c$5("invalid callback");
			...
			onConnect(r, o$5) {
				...
				A(this.callback), this.abort = r, this.context = o$5;
			}
			onHeaders(r, o$5, N, l$1) {
				const { callback: I, opaque: p$1, abort: b, context: G$1, responseHeaders: J$1, highWaterMark: V } = this, _$1 = J$1 === "raw" ? t$6.parseRawHeaders(o$5) : t$6.parseHeaders(o$5);
				if (r < 200) {
				...
				const q$1 = J$1 === "raw" ? t$6.parseHeaders(o$5) : _$1, M = q$1["content-type"], Y = q$1["content-length"], m$3 = new k$1({
					resume: N,
					abort: b,
					contentType: M,
			...
			onError(r) {
				const { res: o$5, callback: N, body: l$1, opaque: I } = this;
				N && (this.callback = null, queueMicrotask(() => {
					this.runInAsyncScope(N, null, r, { opaque: I });
				})), o$5 && (this.res = null, queueMicrotask(() => {
					t$6.destroy(o$5, r);
				})), l$1 && (this.body = null, t$6.destroy(l$1, r)), this.removeAbortListener && (o$5?.off("close", this.removeAbortListener), this.removeAbortListener(), this.removeAbortListener = null);
			}
		};
		e(D, "RequestHandler");
		let F$3 = D;
		function Q(U, r) {
			if (r === void 0) return new Promise((o$5, N) => {
				Q.call(this, U, (l$1, I) => l$1 ? N(l$1) : o$5(I));
			});
			try {
				this.dispatch(U, new F$3(U, r));
			} catch (o$5) {
				if (typeof r != "function") throw o$5;
				const N = U?.opaque;
				queueMicrotask(() => r(o$5, { opaque: N }));
			}
		}
		return e(Q, "request"), apiRequest.exports = Q, apiRequest.exports.RequestHandler = F$3, apiRequest.exports;
	}
	...
	function requireAbortSignal() {
		...
		return e(R$3, "removeSignal"), abortSignal = {
			addSignal: y$3,
			removeSignal: R$3
		}, abortSignal;
	}
	...
	function requireApiStream() {
		...
		const A = require$$0__default$1, { finished: k$1, PassThrough: c$5 } = Stream__default, { InvalidArgumentError: B, InvalidReturnValueError: t$6 } = requireErrors(), y$3 = requireUtil$7(), { getResolveErrorBodyCallback: R$3 } = requireUtil$5(), { AsyncResource: F$3 } = require$$5__default$2, { addSignal: Q, removeSignal: D } = requireAbortSignal(), o$5 = class o$6 extends F$3 {
	...
	function requireApiPipeline() {
		...
		const G$1 = class G$2 extends F$3 {
			constructor(V, _$1) {
				...
				super("UNDICI_PIPELINE"), this.opaque = Y || null, this.responseHeaders = f$4 || null, this.handler = _$1, this.abort = null, this.context = null, this.onInfo = m$3 || null, this.req = new o$5().on("error", R$3.nop), this.ret = new k$1({
		...
		return e(I, "pipeline"), apiPipeline = I, apiPipeline;
	}
	...
	function requireApiUpgrade() {
		...
		const { InvalidArgumentError: A, SocketError: k$1 } = requireErrors(), { AsyncResource: c$5 } = require$$5__default$2, B = requireUtil$7(), { addSignal: t$6, removeSignal: y$3 } = requireAbortSignal(), R$3 = require$$0__default$1, D = class D$1 extends c$5 {
			constructor(r, o$5) {
				...
				if (typeof o$5 != "function") throw new A("invalid callback");
				...
				super("UNDICI_UPGRADE"), this.responseHeaders = I || null, this.opaque = l$1 || null, this.callback = o$5, this.abort = null, this.context = null, t$6(this, N);
			}
			onConnect(r, o$5) {
				if (this.reason) {
					r(this.reason);
			...
			onUpgrade(r, o$5, N) {
				...
				const b = this.responseHeaders === "raw" ? B.parseRawHeaders(o$5) : B.parseHeaders(o$5);
			...
			onError(r) {
				const { callback: o$5, opaque: N } = this;
				y$3(this), o$5 && (this.callback = null, queueMicrotask(() => {
					this.runInAsyncScope(o$5, null, r, { opaque: N });
				}));
			}
		};
		e(D, "UpgradeHandler");
	...
	function requireApiConnect() {
		...
		const A = require$$0__default$1, { AsyncResource: k$1 } = require$$5__default$2, { InvalidArgumentError: c$5, SocketError: B } = requireErrors(), t$6 = requireUtil$7(), { addSignal: y$3, removeSignal: R$3 } = requireAbortSignal(), D = class D$1 extends k$1 {
			constructor(r, o$5) {
				...
				const { signal: N, opaque: l$1, responseHeaders: I } = r;
				if (N && typeof N.on != "function" && typeof N.addEventListener != "function") throw new c$5("signal must be an EventEmitter or EventTarget");
				super("UNDICI_CONNECT"), this.opaque = l$1 || null, this.responseHeaders = I || null, this.callback = o$5, this.abort = null, y$3(this, N);
			}
			onConnect(r, o$5) {
				if (this.reason) {
					r(this.reason);
			...
			onUpgrade(r, o$5, N) {
				...
				let b = o$5;
				b != null && (b = this.responseHeaders === "raw" ? t$6.parseRawHeaders(o$5) : t$6.parseHeaders(o$5)), this.runInAsyncScope(l$1, null, null, {
					statusCode: r,
					headers: b,
					socket: N,
					opaque: I,
			...
			onError(r) {
				const { callback: o$5, opaque: N } = this;
				R$3(this), o$5 && (this.callback = null, queueMicrotask(() => {
					this.runInAsyncScope(o$5, null, r, { opaque: N });
				}));
			}
		};
	...
	function requireMockUtils() {
		...
		e(o$5, "buildHeadersFromArray");
		function N(C$1, w$2) {
			if (typeof C$1.headers == "function") return Array.isArray(w$2) && (w$2 = o$5(w$2)), C$1.headers(w$2 ? U(w$2) : {});
		...
		function Y(C$1, w$2) {
			...
			function pA(kA, bA = $) {
				const gA = Array.isArray(C$1.headers) ? o$5(C$1.headers) : C$1.headers, DA = typeof bA == "function" ? bA({
					...C$1,
					headers: gA
				}) : bA;
				if (Q(DA)) {
		...
		return e(n$4, "buildMockOptions"), mockUtils = {
			getResponseData: p$1,
			getMockDispatch: b,
			addMockDispatch: G$1,
	...
	function requirePluralizer() {
		...
		}, e(c$5, "Pluralizer"), c$5), pluralizer;
	}
	...
	function requirePendingInterceptorsFormatter() {
		...
		return pendingInterceptorsFormatter = (t$6 = class {
			...
			format(R$3) {
				const F$3 = R$3.map(({ method: Q, path: D, data: { statusCode: U }, persist: r, times: o$5, timesInvoked: N, origin: l$1 }) => ({
					Method: Q,
					Origin: l$1,
					Path: D,
					"Status code": U,
					Persistent: r ? c$5 : B,
					Invocations: N,
					Remaining: r ? Infinity : o$5 - N
				}));
				return this.logger.table(F$3), this.transform.read().toString();
			}
		}, e(t$6, "PendingInterceptorsFormatter"), t$6), pendingInterceptorsFormatter;
	}
	...
	function requireMockAgent() {
		...
		const { kClients: A } = requireSymbols$4(), k$1 = requireAgent(), { kAgent: c$5, kMockAgentSet: B, kMockAgentGet: t$6, kDispatches: y$3, kIsMockActive: R$3, kNetConnect: F$3, kGetNetConnect: Q, kOptions: D, kFactory: U } = requireMockSymbols(), r = requireMockClient(), o$5 = requireMockPool(), { matchValue: N, buildMockOptions: l$1 } = requireMockUtils(), { InvalidArgumentError: I, UndiciError: p$1 } = requireErrors(), b = requireDispatcher(), G$1 = requirePluralizer(), J$1 = requirePendingInterceptorsFormatter(), _$1 = class _$2 extends b {
			constructor(M) {
			...
			[U](M) {
				...
				return this[D] && this[D].connections === 1 ? new r(M, Y) : new o$5(M, Y);
			}
			[t$6](M) {
...
`.trim());
	...
	function requireGlobal() {
		...
		e(B, "setGlobalDispatcher");
		function t$6() {
			return globalThis[A];
		}
		return e(t$6, "getGlobalDispatcher"), global = {
	...
	function requireDecoratorHandler() {
		...
		}, A = /* @__PURE__ */ new WeakMap(), e(k$1, "DecoratorHandler"), k$1)), decoratorHandler;
	}
	...
	function requireRetry() {
		...
		return retry = e((k$1) => (c$5) => e(function(t$6, y$3) {
	...
	function requireDump() {
		...
		const A = requireUtil$7(), { InvalidArgumentError: k$1, RequestAbortedError: c$5 } = requireErrors(), B = requireDecoratorHandler(), I = class I$1 extends B {
			constructor({ maxSize: G$1 }, J$1) {
				...
				mA(this, R$3, G$1 ?? Z(this, R$3)), mA(this, o$5, J$1);
			}
			onConnect(G$1) {
				mA(this, F$3, G$1), Z(this, o$5).onConnect(ee(this, N, xe).bind(this));
			}
			onHeaders(G$1, J$1, V, _$1) {
				...
				return Z(this, D) ? !0 : Z(this, o$5).onHeaders(G$1, J$1, V, _$1);
			}
			onError(G$1) {
				Z(this, Q) || (G$1 = Z(this, r) ?? G$1, Z(this, o$5).onError(G$1));
			}
			onData(G$1) {
				return mA(this, U, Z(this, U) + G$1.length), Z(this, U) >= Z(this, R$3) && (mA(this, Q, !0), Z(this, D) ? Z(this, o$5).onError(Z(this, r)) : Z(this, o$5).onComplete([])), !0;
			}
			onComplete(G$1) {
				if (!Z(this, Q)) {
					if (Z(this, D)) {
						Z(this, o$5).onError(this.reason);
						return;
					}
					Z(this, o$5).onComplete(G$1);
				}
			}
		};
		R$3 = /* @__PURE__ */ new WeakMap(), F$3 = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), r = /* @__PURE__ */ new WeakMap(), o$5 = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakSet(), xe = e(function(G$1) {
			mA(this, D, !0), mA(this, r, G$1);
		}, "#customAbort"), e(I, "DumpHandler");
		let t$6 = I;
		function y$3({ maxSize: p$1 } = { maxSize: 1024 * 1024 }) {
			return (b) => e(function(J$1, V) {
				const { dumpMaxSize: _$1 = p$1 } = J$1;
				return b(J$1, new t$6({ maxSize: _$1 }, V));
			}, "Intercept");
		}
		return e(y$3, "createDumpInterceptor"), dump = y$3, dump;
	}
	...
	function requireDns() {
		...
		Q = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), r = /* @__PURE__ */ new WeakSet(), We = e(function(q$1, M, Y) {
			k$1(q$1.hostname, {
				all: !0,
		...
		}, "#defaultLookup"), qe = e(function(q$1, M, Y) {
			let m$3 = null;
		...
		I = /* @__PURE__ */ new WeakMap(), p$1 = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new WeakMap(), G$1 = /* @__PURE__ */ new WeakMap(), J$1 = /* @__PURE__ */ new WeakMap(), e(V, "DNSDispatchHandler");
		let F$3 = V;
		return dns = e((_$1) => {
	...
	function requireHeaders() {
		...
		const Y = class Y$1 {
			constructor(f$4 = void 0) {
				SA(this, q$1);
				SA(this, M);
				y$3.util.markAsUncloneable(this), f$4 !== A && (mA(this, M, new I()), mA(this, q$1, "none"), f$4 !== void 0 && (f$4 = y$3.converters.HeadersInit(f$4, "Headers contructor", "init"), o$5(this, f$4)));
			}
			append(f$4, n$4) {
		...
		q$1 = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), e(Y, "Headers");
		let p$1 = Y;
	...
	function requireResponse() {
		...
		const { Headers: A, HeadersList: k$1, fill: c$5, getHeadersGuard: B, setHeadersGuard: t$6, setHeadersList: y$3 } = requireHeaders(), { extractBody: R$3, cloneBody: F$3, mixinBody: Q, hasFinalizationRegistry: D, streamRegistry: U, bodyUnusable: r } = requireBody(), o$5 = requireUtil$7(), N = require$$0__default$3, { kEnumerableProperty: l$1 } = o$5, { isValidReasonPhrase: I, isCancelled: p$1, isAborted: b, isBlobLike: G$1, serializeJavascriptValueToJSONString: J$1, isErrorLike: V, isomorphicEncode: _$1, environmentSettingsObject: q$1 } = requireUtil$6(), { redirectStatusSet: M, nullBodyStatus: Y } = requireConstants$2(), { kState: m$3, kHeaders: f$4 } = requireSymbols$3(), { webidl: n$4 } = requireWebidl(), { FormData: C$1 } = requireFormdata(), { URLSerializer: w$2 } = requireDataUrl(), { kConstruct: S$1 } = requireSymbols$4(), x = require$$0__default$1, { types: z$1 } = require$$0__default$3, $ = new TextEncoder("utf-8"), bA = class bA$1 {
			static error() {
			...
			get bodyUsed() {
				return n$4.brandCheck(this, bA$1), !!this[m$3].body && o$5.isDisturbed(this[m$3].body.stream);
			}
			clone() {
		...
		e(pA, "makeAppropriateNetworkError");
		...
		return e(kA, "fromInnerResponse"), n$4.converters.ReadableStream = n$4.interfaceConverter(ReadableStream), n$4.converters.FormData = n$4.interfaceConverter(C$1), n$4.converters.URLSearchParams = n$4.interfaceConverter(URLSearchParams), n$4.converters.XMLHttpRequestBodyInit = function(gA, DA, oA) {
			return typeof gA == "string" ? n$4.converters.USVString(gA, DA, oA) : G$1(gA) ? n$4.converters.Blob(gA, DA, oA, { strict: !1 }) : ArrayBuffer.isView(gA) || z$1.isArrayBuffer(gA) ? n$4.converters.BufferSource(gA, DA, oA) : o$5.isFormDataLike(gA) ? n$4.converters.FormData(gA, DA, oA, { strict: !1 }) : gA instanceof URLSearchParams ? n$4.converters.URLSearchParams(gA, DA, oA) : n$4.converters.DOMString(gA, DA, oA);
		...
		}, n$4.converters.ResponseInit = n$4.dictionaryConverter([
			{
				...
				defaultValue: e(() => 200, "defaultValue")
			},
			{
				key: "statusText",
	...
	function requireRequest() {
		...
		const EA = class EA$1 {
			constructor(NA, wA = {}) {
				...
				if (this[w$2] = ne.signal, OA != null) {
					...
					if (OA.aborted) ne.abort(OA.reason);
						...
						o$5.addAbortListener(OA, yA), pA.register(ne, {
							signal: OA,
							abort: yA
						}, yA);
					}
			...
			get bodyUsed() {
				return z$1.brandCheck(this, EA$1), !!this[S$1].body && o$5.isDisturbed(this[S$1].body.stream);
			}
			get duplex() {
			...
			clone() {
				...
				if (this.signal.aborted) wA.abort(this.signal.reason);
					...
					vA.add(dA), o$5.addAbortListener(wA.signal, kA(dA));
				}
		...
		return e(aA, "fromInnerRequest"), Object.defineProperties(gA.prototype, {
			method: m$3,
			url: m$3,
			headers: m$3,
			redirect: m$3,
	...
	function requireFetch() {
		...
		async function GA(AA, v$2 = !1) {
			...
			let j$2 = null;
			if (X$2.localURLsOnly && !K$1(p$1(X$2)) && (j$2 = A("local URLs only")), G$1(X$2), o$5(X$2) === "blocked" && (j$2 = A("bad port")), X$2.referrerPolicy === "" && (X$2.referrerPolicy = X$2.policyContainer.referrerPolicy), X$2.referrer !== "no-referrer" && (X$2.referrer = M(X$2)), j$2 === null && (j$2 = await (async () => {
				const rA = p$1(X$2);
			...
			if (tA.urlList.length === 0 && tA.urlList.push(...X$2.urlList), X$2.timingAllowFailed || (j$2.timingAllowPassed = !0), j$2.type === "opaque" && tA.status === 206 && tA.rangeRequested && !X$2.headers.contains("range", !0) && (j$2 = tA = A()), j$2.status !== 0 && (X$2.method === "HEAD" || X$2.method === "CONNECT" || aA.includes(tA.status)) && (tA.body = null, AA.controller.dump = !0), X$2.integrity) {
				const rA = e((TA) => BA(AA, A(TA)), "processBodyError");
			...
			function Qe({ body: qA }) {
				...
				return new Promise((re, Be) => ce.dispatch({
					...
					onHeaders(ge, Ee, Fe, we) {
						...
						Le && (le = Le.toLowerCase().split(",").map((Ce) => Ce.trim())), Se$1 = ye.get("location", !0), this.body = new vA({ read: Fe });
						const he = [], Ke = Se$1 && j$2.redirect === "follow" && oA.has(ge);
		...
		return e(zA, "httpNetworkFetch"), fetch_1 = {
			fetch: WA,
			Fetch: LA,
			fetching: Ie,
	...
	function requireUtil$4() {
		...
		return e(G$1, "combineByteSequences"), util$4 = {
			staticPropertyDescriptors: o$5,
			readOperation: N,
	...
	function requireUtil$3() {
		...
		return e(t$6, "getFieldValues"), util$3 = {
			urlEquals: B,
			getFieldValues: t$6
		}, util$3;
	}
	...
	function requireCache() {
		...
		hasRequiredCache = 1;
		const { kConstruct: A } = requireSymbols$1(), { urlEquals: k$1, getFieldValues: c$5 } = requireUtil$3(), { kEnumerableProperty: B, isDisturbed: t$6 } = requireUtil$7(), { webidl: y$3 } = requireWebidl(), { Response: R$3, cloneResponse: F$3, fromInnerResponse: Q } = requireResponse(), { Request: D, fromInnerRequest: U } = requireRequest(), { kState: r } = requireSymbols$3(), { fetching: o$5 } = requireFetch(), { urlIsHttpHttpsScheme: N, createDeferredPromise: l$1, readAllBytes: I } = requireUtil$6(), p$1 = require$$0__default$1, m$3 = class m$4 {
			constructor() {
				SA(this, V);
				SA(this, J$1);
		...
		J$1 = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakSet(), pe = e(function(n$4) {
		...
		}, "#batchCacheOperations"), ue = e(function(n$4, C$1, w$2) {
			...
			return S$1;
		}, "#queryCache"), Oe = e(function(n$4, C$1, w$2 = null, S$1) {
			...
			return !0;
		}, "#requestMatchesCachedItem"), be = e(function(n$4, C$1, w$2 = Infinity) {
			let S$1 = null;
			if (n$4 !== void 0) if (n$4 instanceof D) {
				if (S$1 = n$4[r], S$1.method !== "GET" && !C$1.ignoreMethod) return [];
			} else typeof n$4 == "string" && (S$1 = new D(n$4)[r]);
	...
	function requireCachestorage() {
		...
		const { kConstruct: A } = requireSymbols$1(), { Cache: k$1 } = requireCache(), { webidl: c$5 } = requireWebidl(), { kEnumerableProperty: B } = requireUtil$7(), R$3 = class R$4 {
			...
			async match(Q, D = {}) {
				if (c$5.brandCheck(this, R$4), c$5.argumentLengthCheck(arguments, 1, "CacheStorage.match"), Q = c$5.converters.RequestInfo(Q), D = c$5.converters.MultiCacheQueryOptions(D), D.cacheName != null) {
					...
					const o$5 = await new k$1(A, U).match(Q, D);
					if (o$5 !== void 0) return o$5;
				}
			}
			async has(Q) {
		...
		y$3 = /* @__PURE__ */ new WeakMap(), e(R$3, "CacheStorage");
		let t$6 = R$3;
	...
	function requireUtil$2() {
		...
		hasRequiredUtil$2 = 1;
		function A(r) {
			for (let o$5 = 0; o$5 < r.length; ++o$5) {
				const N = r.charCodeAt(o$5);
		...
		e(k$1, "validateCookieName");
		function c$5(r) {
			let o$5 = r.length, N = 0;
			if (r[0] === "\"") {
				if (o$5 === 1 || r[o$5 - 1] !== "\"") throw new Error("Invalid cookie value");
				--o$5, ++N;
			}
			for (; N < o$5;) {
		...
		const y$3 = [
			...
			"Nov",
			"Dec"
		], F$3 = Array(61).fill(0).map((r, o$5) => o$5.toString().padStart(2, "0"));
		function Q(r) {
		...
		e(D, "validateCookieMaxAge");
		function U(r) {
			if (r.name.length === 0) return null;
			k$1(r.name), c$5(r.value);
			const o$5 = [`${r.name}=${r.value}`];
			r.name.startsWith("__Secure-") && (r.secure = !0), r.name.startsWith("__Host-") && (r.secure = !0, r.domain = null, r.path = "/"), r.secure && o$5.push("Secure"), r.httpOnly && o$5.push("HttpOnly"), typeof r.maxAge == "number" && (D(r.maxAge), o$5.push(`Max-Age=${r.maxAge}`)), r.domain && (t$6(r.domain), o$5.push(`Domain=${r.domain}`)), r.path && (B(r.path), o$5.push(`Path=${r.path}`)), r.expires && r.expires.toString() !== "Invalid Date" && o$5.push(`Expires=${Q(r.expires)}`), r.sameSite && o$5.push(`SameSite=${r.sameSite}`);
			for (const N of r.unparsed) {
				if (!N.includes("=")) throw new Error("Invalid unparsed");
				const [l$1, ...I] = N.split("=");
				o$5.push(`${l$1.trim()}=${I.join("=")}`);
			}
			return o$5.join("; ");
		}
		return e(U, "stringify"), util$2 = {
	...
	function requireParse() {
		...
		function y$3(F$3) {
			...
			let Q = "", D = "", U = "", r = "";
			if (F$3.includes(";")) {
				const o$5 = { position: 0 };
				Q = B(";", F$3, o$5), D = F$3.slice(o$5.position);
			} else Q = F$3;
			if (!Q.includes("=")) r = Q;
			else {
				const o$5 = { position: 0 };
				U = B("=", Q, o$5), r = Q.slice(o$5.position + 1);
			}
		...
		function R$3(F$3, Q = {}) {
			...
			const o$5 = U.toLowerCase();
			if (o$5 === "expires") Q.expires = new Date(r);
			else if (o$5 === "max-age") {
			...
			} else if (o$5 === "secure") Q.secure = !0;
			else if (o$5 === "httponly") Q.httpOnly = !0;
			else if (o$5 === "samesite") {
				let N = "Default";
		...
		return e(R$3, "parseUnparsedAttributes"), parse = {
			parseSetCookie: y$3,
	...
	function requireCookies() {
		...
		return e(F$3, "setCookie"), c$5.converters.DeleteCookieAttributes = c$5.dictionaryConverter([{
			converter: c$5.nullableConverter(c$5.converters.DOMString),
			key: "path",
			defaultValue: e(() => null, "defaultValue")
		}, {
			converter: c$5.nullableConverter(c$5.converters.DOMString),
			key: "domain",
			defaultValue: e(() => null, "defaultValue")
			...
			},
			{
				...
				key: "unparsed",
				defaultValue: e(() => new Array(0), "defaultValue")
			}
		]), cookies = {
			getCookies: t$6,
			deleteCookie: y$3,
	...
	function requireEvents() {
		...
		D = /* @__PURE__ */ new WeakMap(), e(r, "MessageEvent");
		let t$6 = r;
		...
		const N = class N$1 extends Event {
			constructor(G$1, J$1 = {}) {
				...
				super(G$1, J$1);
				SA(this, o$5);
				mA(this, o$5, J$1), A.util.markAsUncloneable(this);
			}
			get wasClean() {
				return A.brandCheck(this, N$1), Z(this, o$5).wasClean;
			}
			get code() {
				return A.brandCheck(this, N$1), Z(this, o$5).code;
			}
			get reason() {
				return A.brandCheck(this, N$1), Z(this, o$5).reason;
			}
		};
		o$5 = /* @__PURE__ */ new WeakMap(), e(N, "CloseEvent");
		let R$3 = N;
		...
		l$1 = /* @__PURE__ */ new WeakMap(), e(I, "ErrorEvent");
		let F$3 = I;
	...
	function requireFrame() {
		...
		try {
			...
			c$5 = { randomFillSync: e(function(D, U, r) {
				for (let o$5 = 0; o$5 < D.length; ++o$5) D[o$5] = Math.random() * 255 | 0;
				return D;
			}, "randomFillSync") };
		}
		function y$3() {
		...
		const F$3 = class F$4 {
			...
			createFrame(D) {
				const U = this.frameData, r = y$3(), o$5 = U?.byteLength ?? 0;
				let N = o$5, l$1 = 6;
				o$5 > A ? (l$1 += 8, N = 127) : o$5 > 125 && (l$1 += 2, N = 126);
				const I = Buffer.allocUnsafe(o$5 + l$1);
				I[0] = I[1] = 0, I[0] |= 128, I[0] = (I[0] & 240) + D;
				/*! ws. MIT License. Einar Otto Stangvik <einaros@gmail.com> */ I[l$1 - 4] = r[0], I[l$1 - 3] = r[1], I[l$1 - 2] = r[2], I[l$1 - 1] = r[3], I[1] = N, N === 126 ? I.writeUInt16BE(o$5, 2) : N === 127 && (I[2] = I[3] = 0, I.writeUIntBE(o$5, 4, 6)), I[1] |= 128;
				for (let p$1 = 0; p$1 < o$5; ++p$1) I[l$1 + p$1] = U[p$1] ^ r[p$1 & 3];
				return I;
			}
		};
		e(F$3, "WebsocketFrameSend");
	...
	function requireConnection() {
		...
		const { uid: A, states: k$1, sentCloseFrameState: c$5, emptyBuffer: B, opcodes: t$6 } = requireConstants(), { kReadyState: y$3, kSentClose: R$3, kByteParser: F$3, kReceivedClose: Q, kResponse: D } = requireSymbols(), { fireEvent: U, failWebsocketConnection: r, isClosing: o$5, isClosed: N, isEstablished: l$1, parseExtensions: I } = requireUtil$1(), { channels: p$1 } = requireDiagnostics(), { CloseEvent: b } = requireEvents(), { makeRequest: G$1 } = requireRequest(), { fetching: J$1 } = requireFetch(), { Headers: V, getHeadersList: _$1 } = requireHeaders(), { getDecodeSplit: q$1 } = requireUtil$6(), { WebsocketFrameSend: M } = requireFrame();
		let Y;
		try {
		...
		e(m$3, "establishWebSocketConnection");
		function f$4(S$1, x, z$1, $) {
			if (!(o$5(S$1) || N(S$1))) if (!l$1(S$1)) r(S$1, "Connection was closed before it was established."), S$1[y$3] = k$1.CLOSING;
		...
		e(f$4, "closeWebSocketConnection");
		function n$4(S$1) {
		...
		return e(w$2, "onSocketError"), connection = {
	...
	function requirePermessageDeflate() {
		...
		const { createInflateRaw: A, Z_DEFAULT_WINDOWBITS: k$1 } = zlib__default, { isValidClientWindowBits: c$5 } = requireUtil$1(), B = Buffer.from([
			...
			decompress(r, o$5, N) {
				...
				Z(this, F$3).write(r), o$5 && Z(this, F$3).write(B), Z(this, F$3).flush(() => {
					const l$1 = Buffer.concat(Z(this, F$3)[t$6], Z(this, F$3)[y$3]);
					Z(this, F$3)[t$6].length = 0, Z(this, F$3)[y$3] = 0, N(null, l$1);
				});
			}
		};
		F$3 = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), e(D, "PerMessageDeflate");
	...
	function requireReceiver() {
		...
		const { Writable: A } = Stream__default, k$1 = require$$0__default$1, { parserStates: c$5, opcodes: B, states: t$6, emptyBuffer: y$3, sentCloseFrameState: R$3 } = requireConstants(), { kReadyState: F$3, kSentClose: Q, kResponse: D, kReceivedClose: U } = requireSymbols(), { channels: r } = requireDiagnostics(), { isValidStatusCode: o$5, isValidOpcode: N, failWebsocketConnection: l$1, websocketMessageReceived: I, utf8Decode: p$1, isControlFrame: b, isTextBinaryFrame: G$1, isContinuationFrame: J$1 } = requireUtil$1(), { WebsocketFrameSend: V } = requireFrame(), { closeWebSocketConnection: _$1 } = requireConnection(), { PerMessageDeflate: q$1 } = requirePermessageDeflate(), x = class x$1 extends A {
			constructor(K$1, nA) {
				super();
				SA(this, Y, []);
				SA(this, m$3, 0);
			...
			parseCloseBody(K$1) {
				k$1(K$1.length !== 1);
				let nA;
				if (K$1.length >= 2 && (nA = K$1.readUInt16BE(0)), nA !== void 0 && !o$5(nA)) return {
					code: 1002,
		...
		Y = /* @__PURE__ */ new WeakMap(), m$3 = /* @__PURE__ */ new WeakMap(), f$4 = /* @__PURE__ */ new WeakMap(), n$4 = /* @__PURE__ */ new WeakMap(), C$1 = /* @__PURE__ */ new WeakMap(), w$2 = /* @__PURE__ */ new WeakMap(), S$1 = /* @__PURE__ */ new WeakMap(), e(x, "ByteParser");
	...
	function requireSender() {
		...
		Q = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), r = /* @__PURE__ */ new WeakSet(), Pe = e(async function() {
			mA(this, D, !0);
			const I = Z(this, Q);
			for (; !I.isEmpty();) {
				const p$1 = I.shift();
		...
		return e(F$3, "toBuffer"), sender = { SendQueue: y$3 }, sender;
	}
	...
	function requireWebsocket() {
		...
		const { webidl: A } = requireWebidl(), { URLSerializer: k$1 } = requireDataUrl(), { environmentSettingsObject: c$5 } = requireUtil$6(), { staticPropertyDescriptors: B, states: t$6, sentCloseFrameState: y$3, sendHints: R$3 } = requireConstants(), { kWebSocketURL: F$3, kReadyState: Q, kController: D, kBinaryType: U, kResponse: r, kSentClose: o$5, kByteParser: N } = requireSymbols(), { isConnecting: l$1, isEstablished: I, isClosing: p$1, isValidSubprotocol: b, fireEvent: G$1 } = requireUtil$1(), { establishWebSocketConnection: J$1, closeWebSocketConnection: V } = requireConnection(), { ByteParser: _$1 } = requireReceiver(), { kEnumerableProperty: q$1, isBlobLike: M } = requireUtil$7(), { getGlobalDispatcher: Y } = requireGlobal(), { types: m$3 } = require$$0__default$3, { ErrorEvent: f$4, CloseEvent: n$4 } = requireEvents(), { SendQueue: C$1 } = requireSender(), IA = class IA$1 extends EventTarget {
			constructor(fA, kA = []) {
				...
				this[D] = J$1(oA, kA, aA, this, (EA, sA) => ee(this, uA, Ze).call(this, EA, sA), gA), this[Q] = IA$1.CONNECTING, this[o$5] = y$3.NOT_SENT, this[U] = "blob";
			}
		...
		z$1 = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakMap(), K$1 = /* @__PURE__ */ new WeakMap(), nA = /* @__PURE__ */ new WeakMap(), iA = /* @__PURE__ */ new WeakMap(), uA = /* @__PURE__ */ new WeakSet(), Ze = e(function(fA, kA) {
			this[r] = fA;
		...
		}, "#onConnectionEstablished"), e(IA, "WebSocket");
		let w$2 = IA;
		...
		return e(x, "onParserError"), websocket = { WebSocket: w$2 }, websocket;
	}
	...
	function requireEventsourceStream() {
		...
		const { Transform: A } = Stream__default, { isASCIINumber: k$1, isValidLastEventId: c$5 } = requireUtil(), B = [
			...
			constructor(o$5 = {}) {
				...
				this.state = o$5.eventSourceSettings || {}, o$5.push && (this.push = o$5.push);
			}
			_transform(o$5, N, l$1) {
				if (o$5.length === 0) {
					l$1();
					return;
				}
				if (this.buffer ? this.buffer = Buffer.concat([this.buffer, o$5]) : this.buffer = o$5, this.checkBOM) switch (this.buffer.length) {
					case 1:
			...
			parseLine(o$5, N) {
				if (o$5.length === 0) return;
				const l$1 = o$5.indexOf(R$3);
				if (l$1 === 0) return;
				let I = "", p$1 = "";
				if (l$1 !== -1) {
					I = o$5.subarray(0, l$1).toString("utf8");
					let b = l$1 + 1;
					o$5[b] === F$3 && ++b, p$1 = o$5.subarray(b).toString("utf8");
				} else I = o$5.toString("utf8"), p$1 = "";
				switch (I) {
					case "data":
...
${p$1}`;
			...
			processEvent(o$5) {
				o$5.retry && k$1(o$5.retry) && (this.state.reconnectionTime = parseInt(o$5.retry, 10)), o$5.id && c$5(o$5.id) && (this.state.lastEventId = o$5.id), o$5.data !== void 0 && this.push({
					type: o$5.event || "message",
					options: {
						data: o$5.data,
	...
	function requireEventsource() {
		...
		let r = !1;
		const o$5 = 3e3, N = 0, l$1 = 1, I = 2, p$1 = "anonymous", b = "use-credentials", x = class x$1 extends EventTarget {
			constructor(K$1, nA = {}) {
				super();
				SA(this, C$1);
				SA(this, V, {
		...
		V = /* @__PURE__ */ new WeakMap(), _$1 = /* @__PURE__ */ new WeakMap(), q$1 = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), m$3 = /* @__PURE__ */ new WeakMap(), f$4 = /* @__PURE__ */ new WeakMap(), n$4 = /* @__PURE__ */ new WeakMap(), C$1 = /* @__PURE__ */ new WeakSet(), Ue = e(function() {
			...
			K$1.processResponseEndOfBody = e((iA) => {
	...
	function requireUndici() {
		...
		hasRequiredUndici = 1;
		const A = requireClient(), k$1 = requireDispatcher(), c$5 = requirePool(), B = requireBalancedPool(), t$6 = requireAgent(), y$3 = requireProxyAgent(), R$3 = requireEnvHttpProxyAgent(), F$3 = requireRetryAgent(), Q = requireErrors(), D = requireUtil$7(), { InvalidArgumentError: U } = Q, r = requireApi(), o$5 = requireConnect(), N = requireMockClient(), l$1 = requireMockAgent(), I = requireMockPool(), p$1 = requireMockErrors(), b = requireRetryHandler(), { getGlobalDispatcher: G$1, setGlobalDispatcher: J$1 } = requireGlobal(), V = requireDecoratorHandler(), _$1 = requireRedirectHandler(), q$1 = requireRedirectInterceptor();
		Object.assign(k$1.prototype, r), undici.Dispatcher = k$1, undici.Client = A, undici.Pool = c$5, undici.BalancedPool = B, undici.Agent = t$6, undici.ProxyAgent = y$3, undici.EnvHttpProxyAgent = R$3, undici.RetryAgent = F$3, undici.RetryHandler = b, undici.DecoratorHandler = V, undici.RedirectHandler = _$1, undici.createRedirectInterceptor = q$1, undici.interceptors = {
			...
			dump: requireDump(),
			dns: requireDns()
		}, undici.buildConnector = o$5, undici.errors = Q, undici.util = {
		...
		e(M, "makeDispatcher"), undici.setGlobalDispatcher = J$1, undici.getGlobalDispatcher = G$1;
		const Y = requireFetch().fetch;
		undici.fetch = e(async function(CA, pA = void 0) {
			try {
	...
	function requireHelpers() {
		...
		var A = helpers && helpers.__createBinding || (Object.create ? function(Q, D, U, r) {
			r === void 0 && (r = U);
			var o$5 = Object.getOwnPropertyDescriptor(D, U);
			(!o$5 || ("get" in o$5 ? !D.__esModule : o$5.writable || o$5.configurable)) && (o$5 = {
				enumerable: !0,
				get: e(function() {
					return D[U];
				}, "get")
			}), Object.defineProperty(Q, r, o$5);
		} : function(Q, D, U, r) {
		...
		e(y$3, "toBuffer"), helpers.toBuffer = y$3;
		async function R$3(Q) {
			...
			try {
				...
				const o$5 = r;
				throw o$5.message += ` (input: ${U})`, o$5;
			}
		}
		e(R$3, "json"), helpers.json = R$3;
		function F$3(Q, D = {}) {
			const r = ((typeof Q == "string" ? Q : Q.href).startsWith("https:") ? t$6 : B).request(Q, D), o$5 = new Promise((N, l$1) => {
				r.once("response", N).once("error", l$1).end();
			});
			return r.then = o$5.then.bind(o$5), r;
		}
		return e(F$3, "req"), helpers.req = F$3, helpers;
	}
	e(requireHelpers, "requireHelpers");
	var hasRequiredDist$2;
	function requireDist$2() {
		return hasRequiredDist$2 || (hasRequiredDist$2 = 1, function(A) {
			var k$1 = dist$2 && dist$2.__createBinding || (Object.create ? function(r, o$5, N, l$1) {
				l$1 === void 0 && (l$1 = N);
				var I = Object.getOwnPropertyDescriptor(o$5, N);
				(!I || ("get" in I ? !o$5.__esModule : I.writable || I.configurable)) && (I = {
					enumerable: !0,
					get: e(function() {
						return o$5[N];
					}, "get")
				}), Object.defineProperty(r, l$1, I);
			} : function(r, o$5, N, l$1) {
				l$1 === void 0 && (l$1 = N), r[l$1] = o$5[N];
			}), c$5 = dist$2 && dist$2.__setModuleDefault || (Object.create ? function(r, o$5) {
				...
				var o$5 = {};
				if (r != null) for (var N in r) N !== "default" && Object.prototype.hasOwnProperty.call(r, N) && k$1(o$5, r, N);
				return c$5(o$5, r), o$5;
			}, t$6 = dist$2 && dist$2.__exportStar || function(r, o$5) {
				for (var N in r) N !== "default" && !Object.prototype.hasOwnProperty.call(o$5, N) && k$1(o$5, r, N);
			};
			...
			const Q = Symbol("AgentBaseInternalState"), U = class U$1 extends R$3.Agent {
				...
				isSecureEndpoint(o$5) {
					if (o$5) {
						if (typeof o$5.secureEndpoint == "boolean") return o$5.secureEndpoint;
						if (typeof o$5.protocol == "string") return o$5.protocol === "https:";
					}
					const { stack: N } = /* @__PURE__ */ new Error();
					return typeof N != "string" ? !1 : N.split(`
`).some((l$1) => l$1.indexOf("(https.js:") !== -1 || l$1.indexOf("node:https:") !== -1);
				}
				incrementSockets(o$5) {
					if (this.maxSockets === Infinity && this.maxTotalSockets === Infinity) return null;
					this.sockets[o$5] || (this.sockets[o$5] = []);
					const N = new y$3.Socket({ writable: !1 });
					return this.sockets[o$5].push(N), this.totalSocketCount++, N;
				}
				decrementSockets(o$5, N) {
					if (!this.sockets[o$5] || N === null) return;
					const l$1 = this.sockets[o$5], I = l$1.indexOf(N);
					I !== -1 && (l$1.splice(I, 1), this.totalSocketCount--, l$1.length === 0 && delete this.sockets[o$5]);
				}
				getName(o$5) {
					return this.isSecureEndpoint(o$5) ? F$3.Agent.prototype.getName.call(this, o$5) : super.getName(o$5);
				}
				createSocket(o$5, N, l$1) {
					const I = {
						...N,
						secureEndpoint: this.isSecureEndpoint(N)
					}, p$1 = this.getName(I), b = this.incrementSockets(p$1);
					Promise.resolve().then(() => this.connect(o$5, I)).then((G$1) => {
						if (this.decrementSockets(p$1, b), G$1 instanceof R$3.Agent) try {
							return G$1.addRequest(o$5, I);
						} catch (J$1) {
							return l$1(J$1);
						}
						this[Q].currentSocket = G$1, super.createSocket(o$5, N, l$1);
					}, (G$1) => {
						this.decrementSockets(p$1, b), l$1(G$1);
					});
				}
				createConnection() {
					const o$5 = this[Q].currentSocket;
					if (this[Q].currentSocket = void 0, !o$5) throw new Error("No socket was returned in the `connect()` function");
					return o$5;
				}
				get defaultPort() {
				...
				set defaultPort(o$5) {
					this[Q] && (this[Q].defaultPort = o$5);
				}
				get protocol() {
					return this[Q].protocol ?? (this.isSecureEndpoint() ? "https:" : "http:");
				}
				set protocol(o$5) {
					this[Q] && (this[Q].protocol = o$5);
				}
			};
			e(U, "Agent");
			A.Agent = U;
	...
	function requireMs() {
		...
		ms = e(function(U, r) {
			r = r || {};
			var o$5 = typeof U;
			if (o$5 === "string" && U.length > 0) return R$3(U);
			if (o$5 === "number" && isFinite(U)) return r.long ? Q(U) : F$3(U);
		...
		function R$3(U) {
			if (U = String(U), !(U.length > 100)) {
				...
				if (r) {
					var o$5 = parseFloat(r[1]);
					switch ((r[2] || "ms").toLowerCase()) {
						case "years":
						case "year":
						case "yrs":
						case "yr":
						case "y": return o$5 * y$3;
						case "weeks":
						case "week":
						case "w": return o$5 * t$6;
						case "days":
						case "day":
						case "d": return o$5 * B;
						case "hours":
						...
						case "hrs":
						case "hr":
						case "h": return o$5 * c$5;
						case "minutes":
						case "minute":
						case "mins":
						case "min":
						case "m": return o$5 * k$1;
						case "seconds":
						case "second":
						case "secs":
						case "sec":
		...
		e(Q, "fmtLong");
		function D(U, r, o$5, N) {
			var l$1 = r >= o$5 * 1.5;
			return Math.round(U / o$5) + " " + N + (l$1 ? "s" : "");
		}
		return e(D, "plural"), ms;
	}
	...
	function requireCommon() {
		...
		function A(k$1) {
			...
			function c$5(r) {
				let o$5 = 0;
				for (let N = 0; N < r.length; N++) o$5 = (o$5 << 5) - o$5 + r.charCodeAt(N), o$5 |= 0;
				return B.colors[Math.abs(o$5) % B.colors.length];
			}
			e(c$5, "selectColor"), B.selectColor = c$5;
			function B(r) {
				let o$5, N = null, l$1, I;
				function p$1(...b) {
					if (!p$1.enabled) return;
					const G$1 = p$1, J$1 = Number(/* @__PURE__ */ new Date());
					G$1.diff = J$1 - (o$5 || J$1), G$1.prev = o$5, G$1.curr = J$1, o$5 = J$1, b[0] = B.coerce(b[0]), typeof b[0] != "string" && b.unshift("%O");
					let _$1 = 0;
				...
				return e(p$1, "debug"), p$1.namespace = r, p$1.useColors = B.useColors(), p$1.color = B.selectColor(r), p$1.extend = t$6, p$1.destroy = B.destroy, Object.defineProperty(p$1, "enabled", {
					enumerable: !0,
					configurable: !1,
					get: e(() => N !== null ? N : (l$1 !== B.namespaces && (l$1 = B.namespaces, I = B.enabled(r)), I), "get"),
					set: e((b) => {
						N = b;
					}, "set")
			...
			e(B, "createDebug");
			function t$6(r, o$5) {
				const N = B(this.namespace + (typeof o$5 > "u" ? ":" : o$5) + r);
				return N.log = this.log, N;
			}
			e(t$6, "extend");
			function y$3(r) {
				B.save(r), B.namespaces = r, B.names = [], B.skips = [];
				const o$5 = (typeof r == "string" ? r : "").trim().replace(/\s+/g, ",").split(",").filter(Boolean);
				for (const N of o$5) N[0] === "-" ? B.skips.push(N.slice(1)) : B.names.push(N);
			}
			e(y$3, "enable");
			function R$3(r, o$5) {
				let N = 0, l$1 = 0, I = -1, p$1 = 0;
				for (; N < r.length;) if (l$1 < o$5.length && (o$5[l$1] === r[N] || o$5[l$1] === "*")) o$5[l$1] === "*" ? (I = l$1, p$1 = N, l$1++) : (N++, l$1++);
				else if (I !== -1) l$1 = I + 1, p$1++, N = p$1;
				else return !1;
				for (; l$1 < o$5.length && o$5[l$1] === "*";) l$1++;
				return l$1 === o$5.length;
			}
			e(R$3, "matchesTemplate");
			function F$3() {
				const r = [...B.names, ...B.skips.map((o$5) => "-" + o$5)].join(",");
				return B.enable(""), r;
			}
			e(F$3, "disable");
			function Q(r) {
				for (const o$5 of B.skips) if (R$3(r, o$5)) return !1;
				for (const o$5 of B.names) if (R$3(r, o$5)) return !0;
				return !1;
			}
			e(Q, "enabled");
			function D(r) {
			...
			return e(U, "destroy"), B.enable(B.load()), B;
		}
		return e(A, "setup"), common = A, common;
	}
	...
	function requireBrowser() {
		return hasRequiredBrowser || (hasRequiredBrowser = 1, function(A, k$1) {
			...
			function B(Q) {
				...
				let U = 0, r = 0;
				Q[0].replace(/%[a-zA-Z%]/g, (o$5) => {
					o$5 !== "%%" && (U++, o$5 === "%c" && (r = U));
				}), Q.splice(r, 0, D);
			}
			e(B, "formatArgs"), k$1.log = console.debug || console.log || (() => {});
			function t$6(Q) {
				try {
			...
			e(R$3, "localstorage"), A.exports = requireCommon()(k$1);
	...
	function requireHasFlag() {
		return hasRequiredHasFlag || (hasRequiredHasFlag = 1, hasFlag = e((A, k$1 = process.argv) => {
	...
	function requireSupportsColor() {
		...
		return e(F$3, "getSupportLevel"), supportsColor_1 = {
			supportsColor: F$3,
	...
	function requireNode() {
		return hasRequiredNode || (hasRequiredNode = 1, function(A, k$1) {
			...
			try {
				const o$5 = requireSupportsColor();
				o$5 && (o$5.stderr || o$5).level >= 2 && (k$1.colors = [
					20,
					21,
					26,
					27,
			...
			k$1.inspectOpts = Object.keys(process.env).filter((o$5) => /^debug_/i.test(o$5)).reduce((o$5, N) => {
				const l$1 = N.substring(6).toLowerCase().replace(/_([a-z])/g, (p$1, b) => b.toUpperCase());
				let I = process.env[N];
				return /^(yes|on|true|enabled)$/i.test(I) ? I = !0 : /^(no|off|false|disabled)$/i.test(I) ? I = !1 : I === "null" ? I = null : I = Number(I), o$5[l$1] = I, o$5;
			}, {});
			function t$6() {
			...
			function y$3(o$5) {
				...
				if (l$1) {
					...
					o$5[0] = b + o$5[0].split(`
`).join(`
` + b), o$5.push(p$1 + "m+" + A.exports.humanize(this.diff) + "\x1B[0m");
				} else o$5[0] = R$3() + N + " " + o$5[0];
			}
			e(y$3, "formatArgs");
			function R$3() {
			...
			e(R$3, "getDate");
			function F$3(...o$5) {
				return process.stderr.write(B.formatWithOptions(k$1.inspectOpts, ...o$5) + `
`);
			}
			e(F$3, "log");
			function Q(o$5) {
				o$5 ? process.env.DEBUG = o$5 : delete process.env.DEBUG;
			}
			e(Q, "save");
			function D() {
			...
			function U(o$5) {
				...
				for (let l$1 = 0; l$1 < N.length; l$1++) o$5.inspectOpts[N[l$1]] = k$1.inspectOpts[N[l$1]];
			}
			e(U, "init"), A.exports = requireCommon()(k$1);
			const { formatters: r } = A.exports;
			r.o = function(o$5) {
				return this.inspectOpts.colors = this.useColors, B.inspect(o$5, this.inspectOpts).split(`
`).map((N) => N.trim()).join(" ");
			}, r.O = function(o$5) {
				return this.inspectOpts.colors = this.useColors, B.inspect(o$5, this.inspectOpts);
			};
	...
	function requireParseProxyResponse() {
		...
		function B(t$6) {
			return new Promise((y$3, R$3) => {
				...
				e(D, "read");
				function U() {
					t$6.removeListener("end", r), t$6.removeListener("error", o$5), t$6.removeListener("readable", D);
				}
				e(U, "cleanup");
				function r() {
...
`), G$1 = b.shift();
				...
				e(N, "ondata"), t$6.on("error", o$5), t$6.on("end", r), D();
			});
		}
		return e(B, "parseProxyResponse$1"), parseProxyResponse.parseProxyResponse = B, parseProxyResponse;
	}
	...
	function requireDist() {
		...
		const t$6 = c$5(require$$0__default$6), y$3 = c$5(require$$1__default$7), R$3 = B(require$$2__default), F$3 = B(requireSrc()), Q = requireDist$2(), D = require$$5__default$4, U = requireParseProxyResponse(), r = (0, F$3.default)("https-proxy-agent"), o$5 = e((b) => b.servername === void 0 && b.host && !t$6.isIP(b.host) ? {
			...b,
			servername: b.host
			...
			async connect(G$1, J$1) {
				...
				let _$1;
				V.protocol === "https:" ? (r("Creating `tls.Socket`: %o", this.connectOpts), _$1 = y$3.connect(o$5(this.connectOpts))) : (r("Creating `net.Socket`: %o", this.connectOpts), _$1 = t$6.connect(this.connectOpts));
...
`);
		...
		return e(I, "omit"), dist;
	}
	e(requireDist, "requireDist");
	var distExports = requireDist(), d = Object.defineProperty, O = e((A, k$1, c$5) => k$1 in A ? d(A, k$1, {
		enumerable: !0,
		configurable: !0,
		writable: !0,
		value: c$5
	}) : A[k$1] = c$5, "O"), s = e((A, k$1) => d(A, "name", {
		value: k$1,
		configurable: !0
	}), "s"), i = e((A, k$1, c$5) => O(A, typeof k$1 != "symbol" ? k$1 + "" : k$1, c$5), "i");
	function H(...A) {
	...
	e(P, "P"), s(P, "bypassProxy");
	const g = (fe = class extends undiciExports.ProxyAgent {
		constructor(k$1) {
			super(k$1), this._options = k$1, i(this, "_agent"), this._agent = new undiciExports.Agent();
		}
		dispatch(k$1, c$5) {
			const B = new require$$1$1.URL(k$1.origin).hostname;
			return P(B, this._options.noProxy) ? (H(`Bypassing proxy for: ${B}`), this._agent.dispatch(k$1, c$5)) : super.dispatch(k$1, c$5);
		}
	}, e(fe, "g"), fe);
	s(g, "UndiciProxyAgent");
	let h = g;
	const T = ["http", "https"], E = {
	...
	e(L, "L"), s(L, "isValidProtocol");
	const u = (de = class extends distExports$2.Agent {
		constructor(k$1) {
			super({}), this._options = k$1, i(this, "cache", /* @__PURE__ */ new Map()), i(this, "httpAgent"), i(this, "httpsAgent"), this.httpAgent = new http__namespace.Agent({}), this.httpsAgent = new https__namespace.Agent({});
		}
		connect(k$1, c$5) {
			...
			if (!F$3) {
				...
				const D = E[Q][c$5.secureEndpoint || B ? 1 : 0];
...
function ft() {
	...
	const H$2 = typeof process == "object" && process ? process : {
		stdout: null,
		stderr: null
	}, Z = nt, q$1 = ot, G$1 = ht.StringDecoder, m$3 = Symbol("EOF"), d = Symbol("maybeEmitEnd"), y$3 = Symbol("emittedEnd"), R$3 = Symbol("emittingEnd"), g = Symbol("emittedError"), B = Symbol("closed"), Y = Symbol("read"), T$1 = Symbol("flush"), $ = Symbol("flushChunk"), f$4 = Symbol("encoding"), c$5 = Symbol("decoder"), M = Symbol("flowing"), S$1 = Symbol("paused"), b = Symbol("resume"), i$7 = Symbol("buffer"), a$10 = Symbol("pipes"), n$4 = Symbol("bufferLength"), j$2 = Symbol("bufferPush"), I = Symbol("bufferShift"), o$5 = Symbol("objectMode"), r = Symbol("destroyed"), P$1 = Symbol("error"), x = Symbol("emitData"), V = Symbol("emitEnd"), N = Symbol("emitEnd2"), p$1 = Symbol("async"), _$1 = Symbol("abort"), O$3 = Symbol("aborted"), E$1 = Symbol("signal"), w$2 = (h) => Promise.resolve().then(h), J$1 = commonjsGlobal._MP_NO_ITERATOR_SYMBOLS_ !== "1", K$1 = J$1 && Symbol.asyncIterator || Symbol("asyncIterator not implemented"), W = J$1 && Symbol.iterator || Symbol("iterator not implemented"), k$1 = (h) => h === "end" || h === "finish" || h === "prefinish", tt$1 = (h) => h instanceof ArrayBuffer || typeof h == "object" && h.constructor && h.constructor.name === "ArrayBuffer" && h.byteLength >= 0, et = (h) => !Buffer.isBuffer(h) && ArrayBuffer.isView(h);
	class z$1 {
...
while (this[$](this[I]()) && this[i$7].length);
		...
		[d]() {
			!this[R$3] && !this[y$3] && !this[r] && this[i$7].length === 0 && this[m$3] && (this[R$3] = true, this.emit("end"), this.emit("prefinish"), this.emit("finish"), this[B] && this.emit("close"), this[R$3] = false);
		}
		emit(t$6, e$6, ...s$7) {
...
while (this[_$1](this[B]()));
		...
		pipe(t$6, e$6) {
			if (this[n$4]) return;
			const i$7 = this[c$5];
			return e$6 = e$6 || {}, t$6 === I.stdout || t$6 === I.stderr ? e$6.end = false : e$6.end = e$6.end !== false, e$6.proxyErrors = !!e$6.proxyErrors, i$7 ? e$6.end && t$6.end() : (this.pipes.push(e$6.proxyErrors ? new K$1(this, t$6, e$6) : new U(this, t$6, e$6)), this[d] ? b(() => this[p$1]()) : this[p$1]()), t$6;
		}
		unpipe(t$6) {
		...
		[F$3]() {
			this[c$5] || (this[c$5] = true, this.readable = false, this[d] ? b(() => this[R$3]()) : this[R$3]());
		}
		[R$3]() {
			if (this[m$3]) {
...
function rt() {
	...
	return O$1 = P$1(class extends v$2 {
		constructor(t$6) {
			...
			this.brotli = !t$6.gzip && t$6.brotli !== void 0 ? t$6.brotli : i$7 ? void 0 : false, this.writable = true, this.readable = false, this[f$4] = new W(), this[n$4] = null, this[a$10] = null, this[d] = null, this[h] = "begin", this[c$5] = "", this[l$1] = null, this[y$3] = null, this[u$5] = false, this[r] = null, this[m$3] = false, this[R$3] = false, this[A] = false, this.on("end", () => this[V]()), typeof t$6.onwarn == "function" && this.on("warn", t$6.onwarn), typeof t$6.onentry == "function" && this.on("entry", t$6.onentry);
		}
		[Y](t$6, i$7) {
			...
			if (s$7.nullBlock) this[R$3] ? (this[A] = true, this[h] === "begin" && (this[h] = "header"), this[b]("eof")) : (this[R$3] = true, this[b]("nullBlock"));
			else if (this[R$3] = false, !s$7.cksumValid) this.warn("TAR_ENTRY_INVALID", "checksum failure", { header: s$7 });
...
function X() {
	if (v$1) return s$4;
	v$1 = 1;
	const H$2 = tt(), I = nt.EventEmitter, r = fs$1;
	let R$3 = r.writev;
	if (!R$3) {
		const c$5 = process.binding("fs"), t$6 = c$5.FSReqWrap || c$5.FSReqCallback;
		R$3 = (e$6, i$7, $, A) => {
			const G$1 = (J$1, K$1) => A(J$1, K$1, i$7), j$2 = new t$6();
	...
	class O$3 extends I {
		...
		[x]() {
			if (this[n$4].length === 0) this[g] && this[_$1](null, 0);
				...
				const t$6 = this[n$4];
				this[n$4] = [], R$3(this[s$7], t$6, this[u$5], (e$6, i$7) => this[_$1](e$6, i$7));
			}
		}
		[h]() {
			if (this[m$3] && typeof this[s$7] == "number") {
...
function t$2() {
	if (m$2) return i$2;
	m$2 = 1;
	const { promisify: n$4 } = a$a, e$6 = fs$1;
	return i$2 = (r) => {
		if (!r) r = {
			mode: 511,
			fs: e$6
...
function a$3() {
	if (n$1) return s$2;
	n$1 = 1;
	const i$7 = fs$1, e$6 = (process.env.__TESTING_MKDIRP_NODE_VERSION__ || process.version).replace(/^v/, "").split("."), t$6 = +e$6[0] > 10 || +e$6[0] == 10 && +e$6[1] >= 12;
	return s$2 = {
...
function F$1() {
	if (O) return y$1;
	O = 1;
	const c$5 = fs$1, a$10 = Path, T$1 = c$5.lchown ? "lchown" : "chown", I = c$5.lchownSync ? "lchownSync" : "chownSync", i$7 = c$5.lchown && !process.version.match(/v1[1-9]+\./) && !process.version.match(/v10\.[6-9]/), u$5 = (r, e$6, n$4) => {
		try {
	...
	} : (r, e$6, n$4) => u$5(r, e$6, n$4), R$3 = process.version;
	let N = (r, e$6, n$4) => c$5.readdir(r, e$6, n$4), q$1 = (r, e$6) => c$5.readdirSync(r, e$6);
	/^v4\./.test(R$3) && (N = (r, e$6, n$4) => c$5.readdir(r, n$4));
...
function H() {
	...
	R = 1;
	const g = S(), l$1 = fs$1, p$1 = Path, x = F$1(), y$3 = a$7();
	class D extends Error {
		constructor(e$6, s$7) {
...
function z() {
	if (f$1) return u$1;
	f$1 = 1;
	const l$1 = j$1, m$3 = a$1(), g = s(), { join: d } = Path, q$1 = (process.env.TESTING_TAR_FAKE_PLATFORM || process.platform) === "win32";
	return u$1 = () => {
...
function F() {
	if (o) return e;
	o = 1;
	const t$6 = process.env.__FAKE_PLATFORM__ || process.platform, s$7 = typeof Bun < "u" ? false : t$6 === "win32", { O_CREAT: _$1, O_TRUNC: a$10, O_WRONLY: i$7, UV_FS_O_FILEMAP: r = 0 } = (commonjsGlobal.__FAKE_TESTING_FS__ || fs$1).constants, c$5 = s$7 && !!r, f$4 = 512 * 1024, p$1 = r | a$10 | _$1 | i$7;
...
function Os() {
	if (y) return G;
	y = 1;
	const ss = j$1, is = rt(), r = fs$1, es = X(), w$2 = Path, M = H(), K$1 = p(), ts = z(), os$1 = c(), l$1 = a$7(), rs = s(), hs = a$1(), H$1$1 = Symbol("onEntry"), q$1 = Symbol("checkFs"), Y = Symbol("checkFs2"), v$2 = Symbol("pruneCache"), N = Symbol("isReusable"), d = Symbol("makeFs"), U = Symbol("file"), F$1$1 = Symbol("directory"), O$3 = Symbol("link"), B = Symbol("symlink"), z$1 = Symbol("hardlink"), W = Symbol("unsupported"), j$2 = Symbol("checkPath"), b = Symbol("mkdir"), m$3 = Symbol("onError"), $ = Symbol("pending"), V$1 = Symbol("pend"), S$1 = Symbol("unpend"), P$1 = Symbol("ended"), A = Symbol("maybeClose"), x = Symbol("skip"), E$1 = Symbol("doChown"), R$3 = Symbol("uid"), _$1 = Symbol("gid"), g = Symbol("checkedCwd"), X$1$1 = Ds, J$1 = F(), C$1 = (process.env.TESTING_TAR_FAKE_PLATFORM || process.platform) === "win32", cs = 1024, as = (a$10, s$7) => {
	...
	class L extends is {
		...
		[j$2](s$7) {
			...
			if (this.win32) {
				...
				s$7.absolute = t$6 + K$1.encode(s$7.absolute.slice(t$6.length));
				const { root: o$5 } = w$2.win32.parse(s$7.path);
				s$7.path = o$5 + K$1.encode(s$7.path.slice(o$5.length));
			}
			return true;
		}
		[H$1$1](s$7) {
		...
		[U](s$7, i$7) {
			...
			t$6.on("finish", (c$5) => {
				...
				if (this[E$1](s$7)) {
					o$5++;
					const f$4 = this[R$3](s$7), k$1 = this[_$1](s$7);
		...
		[F$1$1](s$7, i$7) {
			...
			this[b](s$7.absolute, e$6, (t$6) => {
				...
				s$7.mtime && !this.noMtime && (o$5++, r.utimes(s$7.absolute, s$7.atime || /* @__PURE__ */ new Date(), s$7.mtime, u$5)), this[E$1](s$7) && (o$5++, r.chown(s$7.absolute, this[R$3](s$7), this[_$1](s$7), u$5)), u$5();
			});
		}
		[W](s$7) {
	...
	class ls extends L {
		...
		[U](s$7, i$7) {
			...
			u$5 !== s$7 && (u$5.on("error", (h) => this[m$3](h, s$7)), s$7.pipe(u$5)), u$5.on("data", (h) => {
				...
				if (this[E$1](s$7)) {
					const n$4 = this[R$3](s$7), p$1 = this[_$1](s$7);
					try {
		...
		[F$1$1](s$7, i$7) {
			...
			if (this[E$1](s$7)) try {
				r.chownSync(s$7.absolute, this[R$3](s$7), this[_$1](s$7));
			} catch {}
			i$7(), s$7.resume();
		}
		[b](s$7, i$7) {
...
function v() {
	if (q) return f;
	q = 1;
	const w$2 = s$6(), u$5 = Os(), p$1 = fs$1, y$3 = X(), l$1 = Path, m$3 = s();
	f = (r, e$6, o$5) => {
	...
	const d = (r, e$6) => {
		...
		const o$5 = new u$5(r), t$6 = r.maxReadSize || 16 * 1024 * 1024, s$7 = r.file, n$4 = new Promise((i$7, a$10) => {
			o$5.on("error", a$10), o$5.on("close", i$7), p$1.stat(s$7, (c$5, R$3) => {
				if (c$5) a$10(c$5);
				else {
...
var init_default = defineCommand({
	...
	async run(ctx) {
		...
		if (R$2) process$1.stdout.write(`\n${nuxtIcon}\n\n`);
		Nt(colors.bold(`Welcome to Nuxt!`.split("").map((m$3) => `${themeColor}${m$3}`).join("")));
		...
		if (ctx.args.modules !== void 0) for (const segment of (ctx.args.modules || "").split(",")) {
			...
			if (wantsUserModules) {
				...
				const officialModules = response.filter((module$1) => module$1.type === "official" && module$1.npm !== "@nuxt/devtools" && !templateDeps.includes(module$1.npm) && (!module$1.compatibility.nuxt || checkNuxtCompatibility(module$1, nuxtVersion)));
