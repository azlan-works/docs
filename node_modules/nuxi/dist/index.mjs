import { o as __toDynamicImportESM } from "./chunk-Cm1iV3aP.mjs";
import { n as colors, t as consola } from "./dist-CRTRs0Gd.mjs";
import "./utils-D5jIbZ8_.mjs";
import { r as runMain$1, t as defineCommand } from "./dist-BwyUpa_O.mjs";
import { a as p$1 } from "./dist-DS-XJpoP.mjs";
import { n as name, r as version, t as description } from "./package-CwM-B3zv.mjs";
...
import { n as logger, t as debug } from "./logger-wdNiO-Aa.mjs";
...
const commands = {
	"add": () => import("./add-CqEHfDBq.mjs").then(_rDefault),
	"add-template": () => import("./add-template-D_wUGikP.mjs").then(_rDefault),
	"analyze": () => import("./analyze-Df51dUWH.mjs").then(_rDefault),
	"build": () => import("./build-Dhore2TF.mjs").then(_rDefault),
	"cleanup": () => import("./cleanup-V95YLiad.mjs").then(_rDefault),
	"_dev": () => import("./dev-child-D0KHYqSy.mjs").then(_rDefault),
	"dev": () => import("./dev-Cb1fGBM8.mjs").then(_rDefault),
	"devtools": () => import("./devtools-Pit4hquZ.mjs").then(_rDefault),
	"generate": () => import("./generate-B_5WsVvv.mjs").then(_rDefault),
	"info": () => import("./info-8I3LErij.mjs").then(_rDefault),
	"init": () => import("./init-Cv-Jg3MZ.mjs").then(_rDefault),
	"module": () => import("./module-DCJEDcLF.mjs").then(_rDefault),
	"prepare": () => import("./prepare-CN3QRZEd.mjs").then(_rDefault),
	"preview": () => import("./preview-Nx9sT6RA.mjs").then(_rDefault),
	"start": () => import("./preview-Nx9sT6RA.mjs").then(_rDefault),
	"test": () => import("./test-CyHbDUbF.mjs").then(_rDefault),
	"typecheck": () => import("./typecheck-38OOLGOj.mjs").then(_rDefault),
	"upgrade": () => import("./upgrade-DleeJ6QZ.mjs").then(_rDefault)
};

//#endregion
//#region ../../node_modules/.pnpm/@bomb.sh+tab@0.0.11_cac@6.7.14_citty@0.1.6/node_modules/@bomb.sh/tab/dist/t-BWhsyajM.js
function t(e$1, t$1) {
	return `#compdef ${e$1}
compdef _${e$1} ${e$1}
...
[scriptblock]$__${n$1}CompleterBlock = {
    ...
    __${e$1}_debug "QuotedArgs: $QuotedArgs"

    $RequestComp = "& ${t$1} complete '--' $QuotedArgs"
...
var o = class {
	...
	handleFlagCompletion(e$1, t$1, n$1, r$1) {
		...
		if (n$1.includes(`=`)) {
			let [e$2] = n$1.split(`=`);
			i$1 = e$2;
		} else if (r$1?.startsWith(`-`)) {
			let t$2 = this.findOption(e$1, r$1);
			t$2 && !t$2.isBoolean && (i$1 = r$1);
		}
		if (i$1) {
...
//#endregion
//#region ../../node_modules/.pnpm/@bomb.sh+tab@0.0.11_cac@6.7.14_citty@0.1.6/node_modules/@bomb.sh/tab/dist/citty.js
...
async function _(e$1, t$1, n$1) {
	for (let [i$1, a$1] of Object.entries(e$1)) {
		...
		let l$2 = g(e$2), u$2 = t$1 ? `${t$1} ${i$1}` : i$1, d$1 = f$1.command(u$2, o$1.description);
...
async function v(s$2, c$2) {
	...
	if (g(s$2) && s$2.args) for (let [e$1, t$1] of Object.entries(s$2.args)) {
		...
		if (n$1.type === `positional`) {
			...
			i$1 ? f$1.argument(e$1, i$1, t$2) : f$1.argument(e$1, void 0, t$2);
		}
	}
	if (f$2 && await _(f$2, void 0, c$2?.subCommands), s$2.args) for (let [e$1, t$1] of Object.entries(s$2.args)) {
		...
		a$1 ? i$1 ? f$1.option(e$1, n$1.description ?? ``, a$1, i$1) : f$1.option(e$1, n$1.description ?? ``, a$1) : i$1 ? f$1.option(e$1, n$1.description ?? ``, i$1) : f$1.option(e$1, n$1.description ?? ``);
	}
	...
	return f$2 ? f$2.complete = p$2 : s$2.subCommands = { complete: p$2 }, f$1;
}
...
async function checkEngines() {
	const satisfies = await import("./satisfies-CeiDu0PX.mjs").then(__toDynamicImportESM(1)).then((r$1) => r$1.default || r$1);
...
const _main = defineCommand({
	...
	async setup(ctx) {
		...
		if (command === "add" && ctx.rawArgs[1] && templateNames.includes(ctx.rawArgs[1])) {
			...
			await runCommand(await import("./add-template-D_wUGikP.mjs").then((m$1) => m$1.default || m$1), [...ctx.rawArgs.slice(1)]).catch((err) => {
		...
		if (ctx.args.command && !(ctx.args.command in commands)) {
			...
			try {
				const { x } = await import("./main-CerdsJPe.mjs");
